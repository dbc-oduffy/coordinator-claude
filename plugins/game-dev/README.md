...
**Routing:** Registers Sid (game-dev reviewer) for game dev signals with Patrik (architecture reviewer) as backstop. Simple doc lookups route to holodeck-docs plugin's ue-docs-researcher (Sonnet); architecture and review route to Sid (Opus).
