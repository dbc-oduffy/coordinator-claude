...
Addon-vs-addon collision discipline (the Director of Engineering F-Minor 3 2026-05-19):
        ...
        for spec in contributors:
            ...
            if ns in seen_ns:
                ...
                log.warning(
                    ...
                    "(first-wins-with-warning per the Director of Engineering F-Minor 3 2026-05-19)",
                    ns, seen_ns[ns], spec,
                )
                continue
            seen_ns[ns] = spec
