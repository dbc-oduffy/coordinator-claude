...
const { PLUGINS_ROOT, fileExists, dirExists, readJson, listFiles, getDirectoryMarketplaces } = require('./helpers/fs');
...
// versions roll forward. Skip existence assertions for cache-rooted paths so the
// suite reflects committed repo state, not local install state.
