@echo off
setlocal
REM Windows launcher for detect-hardware.sh — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "detect-hardware.sh"
...
:run_baked
"%_py%" "%~dp0detect-hardware.sh" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0detect-hardware.sh" %*
exit /b %ERRORLEVEL%
