@echo off
setlocal
REM Windows launcher for discover-working-repos.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "discover-working-repos.ps1" sibling of
REM     this file over this "discover-working-repos.cmd" file itself -- if both exist, `discover-working-repos`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "discover-working-repos.py"
...
echo [discover-working-repos] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [discover-working-repos] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127

:run_baked
"%_py%" "%~dp0discover-working-repos.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0discover-working-repos.py" %*
exit /b %ERRORLEVEL%
