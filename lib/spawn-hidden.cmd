@echo off
setlocal
REM Windows launcher for spawn-hidden.sh — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "spawn-hidden.sh"
...
:run_baked
"%_py%" "%~dp0spawn-hidden.sh" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0spawn-hidden.sh" %*
exit /b %ERRORLEVEL%
