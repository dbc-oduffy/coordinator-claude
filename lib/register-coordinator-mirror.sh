...
# under concurrent /coordinator:install invocations. Both create-if-absent and
...
# Review: the Staff Engineer F6 — prior comment incorrectly claimed the CLI avoids the registry
