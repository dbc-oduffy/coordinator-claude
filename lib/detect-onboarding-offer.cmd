@echo off
setlocal
REM Windows launcher for detect-onboarding-offer.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "detect-onboarding-offer.ps1" sibling of
REM     this file over this "detect-onboarding-offer.cmd" file itself -- if both exist, `detect-onboarding-offer`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "detect-onboarding-offer.py"
...
echo [detect-onboarding-offer] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [detect-onboarding-offer] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127

:run_baked
"%_py%" "%~dp0detect-onboarding-offer.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0detect-onboarding-offer.py" %*
exit /b %ERRORLEVEL%
