...
The 2026-05-04 holodeck `.uplugin Modules` incident made this concrete. A plan was written, reviewed by Patrik, approved. The plan reintroduced a pattern that `tasks/lessons.md` had explicitly forbidden five days earlier. Nobody read lessons.md before drafting. Nobody read lessons.md inside Patrik's review. The lesson lived on disk, current and correct, and zero downstream consumers were listening.
