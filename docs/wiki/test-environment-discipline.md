...
*Source: example-sim-repo `state/lessons.md` (L12, central-promoted 2026-05-29). [universal]*
...
*Source: example-sim-repo `state/lessons.md` (L14, central-promoted 2026-05-29). [universal]*
...
*Source: project-rag-ue-addon L149, 2026-06-19. [universal]*
...
**Concrete failure (project-rag-ue-addon, 2026-06-19).** `register-plugin` tests patched `claude_home_dir()`, but under xdist workers they intermittently wrote test fixtures into the operator's live `~/.claude/settings.json`, silently corrupting plugin-enable state mid-session.
...
*Source: project-rag, 2026-06-27. [universal]*
