...
Guides when to rename a skill, agent, or doctrine surface, and when to wait.
...
- `docs/wiki/doctrine-authoring/implementation-standards-by-domain.md` § Observability contracts — companion rules for the log-emit shape
- `coordinator/docs/wiki/lesson-triage/dogfooding-doctrine.md` § Cross-References (formerly
