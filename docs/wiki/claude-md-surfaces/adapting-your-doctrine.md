...
related:
  ...
  - coordinator/docs/wiki/em-operating-model/posture-anchors.md  (the anchors' full text)
  -   - coordinator/docs/wiki/install-playbook-rationale/getting-started.md  (Movement 2)
  - coordinator/docs/wiki/dispatching-parallel-agents/eager-agent-calibration.md
---
...
How to self-modify your own operating doctrine within the parts of it that are yours to touch, and where the boundary sits.
...
> see `coordinator/docs/wiki/claude-md-surfaces/claude-md-delivery-topology.md` for the actual delivery mechanics.
...
- Doctrine-layer self-modification does **not** mean the safety-core floor is negotiable. An overlay that
  ...
  `coordinator/docs/wiki/release-and-distribution/overriding-and-tracking-upstream.md` § Floor invariance for the
...
- `.claude/em-context.md` (per repo) § Posture — the posture anchor and where the active posture is
  ...
  across repos.
- `coordinator/docs/wiki/release-and-distribution/overriding-and-tracking-upstream.md` § Floor invariance — the
...
- `coordinator/docs/wiki/em-operating-model/posture-anchors.md` — the anchors' full text and the reasoning behind each
...
- `coordinator/docs/wiki/install-playbook-rationale/getting-started.md` Movement 2 — the conversational, EM-facilitated path to the
  same editable surface, including the Tier-1/Tier-2 framing this page's boundary section restates.
- `coordinator/docs/wiki/dispatching-parallel-agents/eager-agent-calibration.md` — the design-as-offers ethos this page is written
  in: lead with the better alternative, never a nag.
- `coordinator/docs/wiki/release-and-distribution/overriding-and-tracking-upstream.md` — the layer-composition mechanics behind
...
- `coordinator/docs/wiki/claude-md-surfaces/claude-md-delivery-topology.md` — the authoritative account of what
