...
Catalogs what Claude Code exposes to a plugin against what coordinator actually uses.
...
`coordinator/docs/wiki/install-playbook-rationale/percolate-setup.md` for that path.
