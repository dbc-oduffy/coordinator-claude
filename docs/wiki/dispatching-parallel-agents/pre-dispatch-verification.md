...
- `docs/wiki/skills-corpus/tiered-context-loading.md` — what to read before dispatching.
- `docs/wiki/reviewer-pipeline/prior-art-checker.md` — automated pre-flight against accumulated prior art.
- `docs/wiki/reviewer-pipeline/docs-checker-pre-review.md` — automated pre-flight on external API claims.
