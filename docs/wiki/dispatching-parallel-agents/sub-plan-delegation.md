...
related:
  - docs/wiki/planning/writing-plans.md
  - docs/wiki/baton-lifecycle/spinoff-handoffs.md
---
...
Each sub-plan is a full plan in the sense of `docs/wiki/planning/writing-plans.md` — it carries all the substrate-verification discipline: claims, `file:line` citations, pre-dispatch verification, executor constraints.
...
**Accidental spinoff.** A sub-plan grows until the EM cannot integrate it in-session. At that point the sub-plan has effectively become a spinoff. Recognize the signal and escalate — see § When to Escalate below.
...
- `docs/wiki/planning/writing-plans.md` — full plan doctrine; sub-plans must satisfy it
- `docs/wiki/baton-lifecycle/spinoff-handoffs.md` — when to fork rather than hold
- `coordinator/snippets/em-operating-doctrine.md` § How to Plan and Hand Off — plan-skill invocation, dispatch defaults
- `coordinator/skills/handoff/SKILL.md` § Handoff Lineage — spinoff frontmatter and PM-auth gate
