...
*Example: a `--date-prefix` filter erroring on zero-match despite all authored happy-path cases passing.*
...
- [`pre-dispatch-verification.md`](./pre-dispatch-verification.md) — parent doctrine, now the
  canonical bullet-list home (`coordinator/CLAUDE.md` § Pre-Dispatch Verification retired
  2026-07-27)
- [`tiered-context-loading.md`](../skills-corpus/tiered-context-loading.md) — what to read before dispatching
- [`prior-art-checker.md`](../reviewer-pipeline/prior-art-checker.md) — automated pre-flight against accumulated prior art
