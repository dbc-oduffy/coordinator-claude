...
Three concrete shapes from the 2026-04 example-sim-repo shakedown against project-rag v0.5.x, each a deliberate refusal to fix forward in-session:
...
Source: 2026-04 example-sim-repo → project-rag v0.5.x shakedown (`tasks/dogfood-prior-art/example-sim-repo-shakedown-report.md` § 3). [universal]
...
The 2026-05-07 agentic-install-hardening run (the canonical fix-through example from §6) ran this exact shape:
...
Source: 2026-05-07 agentic-install dogfood (`tasks/dogfood-prior-art/example-game-repo-insights-report.md` § 2–4). [universal]
...
*Source: ue-addon 2026-06-15/16 (ue-aware-lsp restart-test pickup; PM correction before writing a `.uproject`-at-workspace-root activation guard).* [universal]
...
*Source: ue-addon 2026-06-15/16 (PM correction twice: "Claude, I'm not going to open the .uproject — this is for you"; "CC is already open, why would I need to open CC").* [universal]
...
*Source: example-game-repo 2026-06-18 (search_tools dispatch-gate not honoring handler's connection-exempt doc).* [universal]
