...
<!-- Purpose: Extended doctrine for synthesizer-role constraints and gap-audit mechanics. The one-liner contract ("Synthesizers assess, fill, and frame — never re-author specialist content") lives in coordinator/CLAUDE.md § Synthesis Discipline; this wiki carries refinements and application rules. -->

**Synthesizers assess, fill, and frame — never re-author specialist content.** Output reading like condensed specialist prose = pipeline failure. Enforced at dispatch in the synthesizer agent prompts. (Canonical statement: `coordinator/CLAUDE.md § Synthesis Discipline`.)
...
Apply at: any synthesizer pass that includes a tier-drift check, a coverage-audit, or a gap-audit step. *Source: 2026-06-15 central-improvement-queue #101.*

---

## Related

- `coordinator/CLAUDE.md § Synthesis Discipline` — canonical one-liner contract.
