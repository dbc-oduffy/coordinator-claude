...
- **Canonical doctrine home** — this file,
  `coordinator/docs/wiki/planning/plan-execute-session-split.md`. Every other surface that touches this
...
- **E1** — this file (`coordinator/docs/wiki/planning/plan-execute-session-split.md`): the canonical
