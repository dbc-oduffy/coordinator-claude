...
- `docs/wiki/planning/writing-plans.md` § Plan Document Lifecycle — plan authors: forecast-vs-shipped reconciliation uses `(was: <plan-forecast>)` ALLOWLIST annotations; `## Deviations` is not auto-written
