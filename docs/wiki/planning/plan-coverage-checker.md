...
Only HEDGE findings produce sidecar entries. Doctrine basis: `coordinator/docs/wiki/doctrine-authoring/implementation-standards-by-domain.md` — "OOS framing must be architectural, not appetite-based."
