...
- **docs-checker** AUTO-FIX corrections land inline per its own contract (`docs/wiki/reviewer-pipeline/docs-checker-pre-review.md`). No integrator pass between docs-checker and the reviewer; the sidecar travels with the artifact for the reviewer's awareness.
...
→ `docs/wiki/reviewer-pipeline/prior-art-checker.md § Bidirectional resolution`  
...
→ `coordinator/docs/wiki/dispatching-parallel-agents/pre-dispatch-verification.md` ("Re-run mechanical pre-flights after material plan amendments")  
→ `docs/wiki/reviewer-pipeline/prior-art-checker.md` for prior-art-checker procedure  
→ `docs/wiki/reviewer-pipeline/docs-checker-pre-review.md` for docs-checker procedure
