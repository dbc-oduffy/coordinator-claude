...
- **Disk-truth over memory.** Per the discharge test (`coordinator/docs/wiki/claude-md-surfaces/invisible-doctrine.md`),
...
- Related: `coordinator/docs/wiki/claude-md-surfaces/invisible-doctrine.md` (discharge test)
