...
/staff-session --mode review --tier standard --members "sid,the Staff Engineer" docs/plans/2026-03-22-example-game-repo-refactor.md

# Full plan session — multi-domain debaters, the Director of Engineering synthesizes
/staff-session --mode plan --tier full --members "the Staff Engineer,sid,the Data Science Reviewer" "Design cross-system AI behavior pipeline"

# Lightweight — falls through to single-reviewer dispatch (no the Director of Engineering synthesis)
/staff-session --mode review --tier lightweight --members "the Staff Engineer" docs/plans/quick-fix.md
```
