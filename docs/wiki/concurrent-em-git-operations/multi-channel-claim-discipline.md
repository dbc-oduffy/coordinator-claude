...
- [`completion-log-release-loop.md`](../release-and-distribution/completion-log-release-loop.md) — completion entries are the canonical surface where channel-scoped claims land for downstream readers.
