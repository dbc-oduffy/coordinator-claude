...
trailer, documented in `coordinator/docs/wiki/ceremony-calibration/workstream-complete-review.md`
...
- `coordinator/docs/wiki/ceremony-calibration/workstream-complete-review.md` — sibling
...
- `coordinator/docs/wiki/schema-and-validation-contracts/canonical-artifact-shapes.md` § lvv-01 — the
