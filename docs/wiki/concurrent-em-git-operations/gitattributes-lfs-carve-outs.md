...
## Silent Failure Chain (project-rag-ue-addon)
...
- → `docs/wiki/concurrent-em-git-operations/lfs-coordinator-auto-push-merge.md` (LFS + post-commit hook interaction)
- → `docs/wiki/dispatching-parallel-agents/agent-dispatch-economics.md` (worktree-creation costs and failure modes)
