...
sources:
  ...
  - coordinator/docs/wiki/lesson-triage/dogfooding-doctrine.md § Cross-References (formerly coordinator/CLAUDE.md § Self-Improvement Loop; relocated here 2026-07-27)
