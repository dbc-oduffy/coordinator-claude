...
(`coordinator/docs/wiki/ceremony-calibration/queue-terminus-doctrine.md`'s outcome class 2 — N queue rows
...
- `coordinator/docs/wiki/ceremony-calibration/queue-terminus-doctrine.md` — the doctrine that produces batons in
...
- `coordinator/docs/wiki/baton-lifecycle/spinoff-handoffs.md` § "Spinoff Granularity" — the bundling
...
- `coordinator/docs/wiki/em-operating-model/initiative-govern-discipline.md` § queue-triage carve-out — how a
