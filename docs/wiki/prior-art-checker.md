...
The output is a sidecar at the plan-derivable `.coordinator-local/plan-sidecars/<plan-stem>.prior-art-check.md` home (D0). The agent makes no judgments and applies no fixes; it surfaces matches with verbatim quotes for the EM to disposition.
