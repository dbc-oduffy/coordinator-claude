...
<!-- Review: code-reviewer — replaced stale plugins/game-dev/agents/staff-game-dev.md (the Game Dev Reviewer) with example-game-repo-resolved note mirroring plan-coverage-checker.md Distribution (F7 nit) -->
