...
- `docs/wiki/test-design-discipline/round-trip-contract-tests.md` — broader contract-test doctrine
- `coordinator/CLAUDE.md` § Implementation Standards (retired; the surviving successor
  is `global-doctrine/CLAUDE.md` § Implementation Standards — Extensions — no equivalent heading
  survives in `coordinator/snippets/em-operating-doctrine.md`, which does not carry a
  "pointer to this wiki" line — no direct successor citation located) — pointer to this wiki
