...
/staff-session --mode review --tier standard --members "game-dev,staff-eng" docs/plans/2026-03-22-example-game-repo-refactor.md

# Full plan session — multi-domain debaters, the Director of Engineering synthesizes
/staff-session --mode plan --tier full --members "staff-eng,game-dev,front-end" "Design cross-system AI behavior pipeline"
...
- Related: [reviewer-routed-workers](../dispatching-parallel-agents/reviewer-routed-workers.md)
