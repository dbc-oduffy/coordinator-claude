...
Skill budget discipline is the practice of keeping every loaded skill's always-on description minimal so context stays available for actual work.
...
> consolidation** — see `docs/wiki/skills-corpus/super-skill-architecture.md § Skill Consolidation` for the
...
(`coordinator/docs/wiki/skills-corpus/super-skill-architecture.md § Skill Consolidation`). Read those records
...
- Super-skill architecture: `docs/wiki/skills-corpus/super-skill-architecture.md`
- Per-project plugin gating: `docs/wiki/install-playbook-rationale/per-project-plugin-gating.md`
