...
**Assembler contract:** `coordinator/docs/wiki/skills-corpus/computed-skills.md` (in progress — first
...
entrypoint (`coordinator/docs/wiki/skills-corpus/writing-skills.md`) is the intended pointer-back location;
...
`docs/wiki/skills-corpus/skill-budget-discipline.md` for the fuller first-hand account and the two questions
...
- Computed skill (Generation 3): `CONTEXT.md § computed skill`, `coordinator/docs/wiki/skills-corpus/computed-skills.md`
