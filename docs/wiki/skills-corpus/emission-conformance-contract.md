...
This page is the normative shared contract between coordinator and claude-klabauter for the DoE-hosted emission-conformance fixture.
...
(`coordinator/docs/wiki/hook-best-practices/step-zero-emitter-contract.md`): same five-part shape (fixture + generator
...
round-trips. → `docs/wiki/test-design-discipline/round-trip-contract-tests.md` for the round-trip fixture discipline.
...
**Two-axis note** (`docs/wiki/schema-and-validation-contracts/schema-version-gate.md`): `contract_version` tracks the
...
this — it gives consumers a re-vendor window before the gate trips. → `docs/wiki/schema-and-validation-contracts/schema-version-gate.md`
...
Registry resolution: `docs/wiki/hook-best-practices/machine-local-registry.md` documents the `repos.doe_claude` key
...
→ `docs/wiki/test-design-discipline/round-trip-contract-tests.md` § Golden-Snapshot Identifier Normalization for the
general discipline.
...
→ `docs/wiki/portability/portable-code-substrate.md` and `docs/wiki/portability/cross-platform-shell-portability.md` for
...
1. **Direct file read of the machine-local registry** at `$HOME/.claude/machine-local/<registryfile>`.
   ...
   stable, well-known absolute location. → `docs/wiki/hook-best-practices/machine-local-registry.md`.
...
- `coordinator/docs/wiki/hook-best-practices/step-zero-emitter-contract.md` — instance #1 of this pattern (Step Zero NDJSON); the emission-conformance fixture is instance #2, mirroring its five-part structure with the added provenance-normalization oracle.
- `docs/wiki/test-design-discipline/round-trip-contract-tests.md` — round-trip fixture discipline and golden-snapshot normalization.
- `docs/wiki/schema-and-validation-contracts/schema-version-gate.md` — two-axis version gate semantics and reader-first bump ordering.
- `docs/wiki/hook-best-practices/machine-local-registry.md` — `repos.doe_claude` registry resolution.
- `docs/wiki/portability/portable-code-substrate.md` — plugin-load PATH-injection mechanics.
- `docs/wiki/portability/cross-platform-shell-portability.md` — cross-platform shell portability (plugin-load PATH context).
- `docs/wiki/hook-best-practices/state-placement-law.md` § Fleet Producer Contract — per-repo emission, live-remote horizon, Tier A/B observation model this Consumer-Tolerance Ledger and producer-contract details are symmetric with.
