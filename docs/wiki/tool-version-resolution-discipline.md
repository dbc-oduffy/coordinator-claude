...
*Lesson surface: 2026-05-06, example-game-workbench-repo — a tool invocation resolved to a different installed version than the operator expected, costing diagnostic time downstream.*
