...
- `docs/wiki/doctrine-authoring/implementation-standards-by-domain.md` — domain-level standards including subprocess and shell integration patterns
- `docs/wiki/dispatching-parallel-agents/pre-dispatch-verification.md` — substrate verification discipline (grep seams before planning)
