...
- `docs/wiki/claude-md-surfaces/claude-code-platform-gotchas.md` — Windows subprocess pop-ups; MCP idiosyncrasies
- `docs/wiki/doctrine-authoring/implementation-standards-by-domain.md` § Windows
- `docs/wiki/baton-lifecycle/multi-session-crash-recovery.md` — full playbook for recovering many sessions killed at once
