...
- CLAUDE.md § Subagent Dispatch — out-of-scope block requirement, destructive-action prohibition for autonomous-write skills. (Haiku billing-gate carve-out and the Opus-only 1M-context tier now live in `dispatching-parallel-agents.md` § Haiku Subagents Do NOT Inherit.)
