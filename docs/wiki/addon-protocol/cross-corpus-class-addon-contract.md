...
This document covers any addon binding — engine, content corpus, knowledge
base, or anything else — renamed from any prior "cross-engine" framing;
"cross-corpus-class" spans engine, example, and knowledge classes.
...
Policy reference: the `project-rag-ue-addon` repo's corpus-band naming-policy decision record
(naming policy + 3-tier stability model).

## 8. Cross-links

- `docs/wiki/addon-protocol/authoring-an-addon.md` — full authoring reference (13 sections, 3 worked examples)
- `docs/wiki/addon-protocol/corpus-class-taxonomy.md` — authority value vocabulary and principled taxonomy
...
- `project-rag-ue-addon` repo's corpus-band naming-policy decision record — naming policy + 3-tier stability model
