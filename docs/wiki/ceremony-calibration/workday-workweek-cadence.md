...
Describes the daily and weekly ceremony cadence — both PM-invoked, both staleness-nudged, distinct from each other.
...
`coordinator/docs/wiki/schema-and-validation-contracts/test-red-state-schema.md`. That record carries a fingerprinted failing
