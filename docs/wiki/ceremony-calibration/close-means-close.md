...
Establishes that closing a workstream is an action the EM takes, not a report the EM produces about what closing would require.
...
- `CLAUDE.md § Flag Severity` / `docs/wiki/em-operating-model/flag-severity-triage.md` — break-class findings are
