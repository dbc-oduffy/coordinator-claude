...
rather than restating it; `docs/wiki/baton-lifecycle/baton-authoring-bar.md` is the sibling wiki defining what a
...
[`baton-authoring-bar.md`](../baton-lifecycle/baton-authoring-bar.md). This wiki names the class; that wiki defines
...
- `docs/wiki/baton-lifecycle/baton-authoring-bar.md` — what a themed baton owes its reader (net-new authoring bar).
- `docs/wiki/baton-lifecycle/spinoff-handoffs.md` — the handoff/spinoff lifecycle this doctrine's batons ride
...
- `docs/wiki/em-operating-model/initiative-govern-discipline.md` — the queue-triage carve-out for reusing the
