...
`coordinator/docs/wiki/schema-and-validation-contracts/schema-version-gate.md` § Reader-first ordering and
`coordinator/docs/wiki/cross-repo-communication/cross-repo-handshake-doctrine.md` establish that a
...
- `coordinator/docs/wiki/schema-and-validation-contracts/schema-version-gate.md` § Reader-first ordering, §
  Dual-gate requirement.
- `coordinator/docs/wiki/cross-repo-communication/cross-repo-handshake-doctrine.md`.
- `coordinator/docs/wiki/claude-md-surfaces/invisible-doctrine.md` § The discharge test.
- `state/cross-repo-commitments/*.yaml`,
