...
<!-- spec-backlink: coordinator/docs/wiki/concurrent-em-git-operations/resolves-commit-trailer.md § Sibling precedent — Deliverable-Id: trailer -->
...
Full trailer-family writeup (vs. `Resolves:` and `Session-Id:`): `coordinator/docs/wiki/concurrent-em-git-operations/resolves-commit-trailer.md` § Sibling precedent — `Deliverable-Id:` trailer.
...
commits' review coverage. See also `docs/wiki/planning/plan-delivery-audit.md` for the full three-oracle
audit skill.
...
- `coordinator/docs/wiki/concurrent-em-git-operations/resolves-commit-trailer.md` — sibling git-native
