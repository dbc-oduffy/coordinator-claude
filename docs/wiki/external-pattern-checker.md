...
- ≥ 2 entries in `state/lessons.md` or the central structured queue (`state/improvement-queue/`, `queue_scope: central`) sharing a noun-phrase from the plan's central abstractions, **or**
