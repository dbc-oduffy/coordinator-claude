...
type: doctrine
related:
  - coordinator/docs/wiki/claude-md-surfaces/adapting-your-doctrine.md
...
This page names the mechanism by which your personal `~/.claude/CLAUDE.md` composes with, rather than replaces, the coordinator plugin's live-resolved surface, while still tracking upstream as it updates.
...
> `coordinator/docs/wiki/claude-md-surfaces/claude-md-delivery-topology.md`. `--plugin-dir` genuinely delivers
...
- `coordinator/docs/wiki/claude-md-surfaces/claude-md-delivery-topology.md` — the authoritative account of what actually
  reaches whom; read before citing this page's floor-invariance claims.
- `coordinator/docs/wiki/claude-md-surfaces/adapting-your-doctrine.md` § "One invariant survives every edit on the supported
