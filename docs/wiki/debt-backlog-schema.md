...
(`docs/wiki/queue-terminus-doctrine.md`) reuses this same FK as its triage-theme grouping key: a
...
`docs/wiki/initiative-govern-discipline.md § Queue-triage themes vs true initiatives` for what
...
pickable baton inbox is low (Queue Terminus Doctrine, `docs/wiki/queue-terminus-doctrine.md`).
...
`docs/wiki/backlog-prune-discipline.md § Age-Ping — Parked-Tier Aging Discipline`, not here.
