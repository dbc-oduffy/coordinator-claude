...
- Parse the status-report table to determine pass/fail. Column names and value enums are
  a stable contract — see `docs/wiki/install-playbook-rationale/coordinator-installer-status-schema.md`.
...
(column names + value enums), see `docs/wiki/install-playbook-rationale/coordinator-installer-status-schema.md`.
...
- **Related wiki updates:**
  - `docs/wiki/install-playbook-rationale/plugin-identity-and-health-sentinels.md` — narrowed scope to
...
Full schema wiki: `docs/wiki/install-playbook-rationale/coordinator-installer-status-schema.md`.
...
| `coordinator/docs/wiki/install-playbook-rationale/coordinator-doctor.md` | **Absent in both** | **Absent in both** (deliberate gap — no dedicated coordinator doctor entry point) |
