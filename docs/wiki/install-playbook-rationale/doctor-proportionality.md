...
- [`guard-proportionality.md`](../guards/guard-proportionality.md) — the sibling rule on the refusal side: how much blocking machinery a fact earns (necessity / duration / outlet), and the standing-guard antipattern it names.
