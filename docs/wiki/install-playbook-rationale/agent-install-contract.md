...
(see `docs/wiki/install-playbook-rationale/install-surface-completeness.md § vacuous-pass anti-pattern`).
...
<!-- boundary: docs/wiki/install-playbook-rationale/install-surface-completeness.md § Post-Consumer Gates Must Be Advisory WARN -->
...
[`state-placement-law.md`](../hook-best-practices/state-placement-law.md) § Taxonomy (line ~38): that table enumerates the
...
forbidden (`docs/wiki/baton-lifecycle/spinoff-handoffs.md`). Install-leg spinoffs are the **one sanctioned
...
(`coordinator/docs/wiki/hook-best-practices/machine-local-registry.md` § 4 Resolution Order): the four-rung ladder
