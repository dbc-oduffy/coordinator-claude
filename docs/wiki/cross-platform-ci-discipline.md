...
- name: Compute deselect markers
  ...
  run: |
    ...
    # Review: code-reviewer F1+F2 — removed 'not (...)' wrapper (double-negation bug) and dead else branch.
