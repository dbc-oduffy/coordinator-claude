...
Setup-class skills should produce the minimum-viable artifacts a downstream system relies on,
not merely prescribe that some later skill run to create them.
