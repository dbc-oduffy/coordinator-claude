...
is rejected by `schema-cli.js --validate` (see `docs/wiki/cross-repo-communication/cross-repo-commitments-schema.md`
...
`docs/wiki/cross-repo-communication/cross-repo-commitments-schema.md` for the full field contract.
...
Applies to the parked tier of the Queue Terminus Doctrine (`docs/wiki/ceremony-calibration/queue-terminus-doctrine.md`)
...
(`status: deferred` with a mandatory `why_blocked`, per `docs/wiki/schema-and-validation-contracts/debt-backlog-schema.md §
...
**Draw-on-demand.** See `docs/wiki/ceremony-calibration/queue-terminus-doctrine.md § "Baton inbox is low" — defined
...
- Structured-form rollout: `docs/wiki/schema-and-validation-contracts/improvement-queue-schema.md` — directory-form shape + `coordinator-queue-append` CLI.
- Schema docs (per-queue field contracts): `docs/wiki/schema-and-validation-contracts/debt-backlog-schema.md`, `docs/wiki/schema-and-validation-contracts/bug-backlog-schema.md`, `docs/wiki/schema-and-validation-contracts/improvement-queue-schema.md`, `docs/wiki/cross-repo-communication/cross-repo-commitments-schema.md`.
- Parked-tier terminus doctrine: `docs/wiki/ceremony-calibration/queue-terminus-doctrine.md` — the four-outcome triage
