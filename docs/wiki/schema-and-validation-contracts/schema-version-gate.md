...
This page documents the schema-version gate that detects cross-repo contract drift at validation time by comparing a record's declared schema version against the validator's own.
