...
See `docs/wiki/dispatching-parallel-agents/delegate-execution.md` → "Scope-Conformance Check" for the dispatch-prompt clause that enforces this on the executor side.
