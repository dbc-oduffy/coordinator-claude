...
4. If the hook fires manually but not at SessionStart: the coordinator plugin may not be loaded in this project. Check repo-root `coordinator.local.md` or global plugin registration.
