@echo off
setlocal
REM Windows launcher for resolve-coordinator-clone — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "resolve-coordinator-clone"
...
:run_baked
"%_py%" "%~dp0resolve-coordinator-clone" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0resolve-coordinator-clone" %*
exit /b %ERRORLEVEL%
