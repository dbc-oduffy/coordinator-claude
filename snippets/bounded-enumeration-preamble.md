...
This snippet is the specific bounded-enumeration variant of the general scout-hallucination class: without it, bounded-backlog scouts fabricate rows for IDs not present in the input list.
