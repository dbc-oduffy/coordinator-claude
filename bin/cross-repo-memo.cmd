@echo off
setlocal
REM Windows launcher for cross-repo-memo — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "cross-repo-memo"
...
:run_baked
"%_py%" "%~dp0cross-repo-memo" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0cross-repo-memo" %*
exit /b %ERRORLEVEL%
