@echo off
setlocal
REM Windows launcher for review-exec-auth-stamp — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "review-exec-auth-stamp"
...
:run_baked
"%_py%" "%~dp0review-exec-auth-stamp" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0review-exec-auth-stamp" %*
exit /b %ERRORLEVEL%
