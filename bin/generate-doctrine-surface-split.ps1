# generate-doctrine-surface-split.ps1 — python-direct Windows launcher for generate-doctrine-surface-split.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "generate-doctrine-surface-split.ps1" file over
#     any co-located "generate-doctrine-surface-split.cmd" sibling -- `generate-doctrine-surface-split` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "generate-doctrine-surface-split.py"
...
$_entry = Join-Path $_here 'generate-doctrine-surface-split.py'
...
[Console]::Error.WriteLine('[generate-doctrine-surface-split] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[generate-doctrine-surface-split] Install Python: https://www.python.org/downloads/windows/')
exit 127
