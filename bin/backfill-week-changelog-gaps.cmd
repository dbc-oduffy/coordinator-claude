@echo off
setlocal
REM Windows launcher for backfill-week-changelog-gaps.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "backfill-week-changelog-gaps.ps1" sibling of
REM     this file over this "backfill-week-changelog-gaps.cmd" file itself -- if both exist, `backfill-week-changelog-gaps`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "backfill-week-changelog-gaps.py"
...
echo [backfill-week-changelog-gaps] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [backfill-week-changelog-gaps] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0backfill-week-changelog-gaps.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0backfill-week-changelog-gaps.py" %*
exit /b %ERRORLEVEL%
