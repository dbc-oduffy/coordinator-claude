@echo off
setlocal
REM Windows launcher for snippet-registry — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "snippet-registry"
...
:run_baked
"%_py%" "%~dp0snippet-registry" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0snippet-registry" %*
exit /b %ERRORLEVEL%
