@echo off
setlocal
REM Windows launcher for repair-empty-review-trail-ranges.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "repair-empty-review-trail-ranges.ps1" sibling of
REM     this file over this "repair-empty-review-trail-ranges.cmd" file itself -- if both exist, `repair-empty-review-trail-ranges`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "repair-empty-review-trail-ranges.py"
...
echo [repair-empty-review-trail-ranges] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [repair-empty-review-trail-ranges] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0repair-empty-review-trail-ranges.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0repair-empty-review-trail-ranges.py" %*
exit /b %ERRORLEVEL%
