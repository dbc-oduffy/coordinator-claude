@echo off
setlocal
REM Windows launcher for seed-skill-overrides.sh — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "seed-skill-overrides.sh"
...
:run_baked
"%_py%" "%~dp0seed-skill-overrides.sh" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0seed-skill-overrides.sh" %*
exit /b %ERRORLEVEL%
