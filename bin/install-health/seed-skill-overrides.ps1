# seed-skill-overrides.ps1 — python-direct Windows launcher for seed-skill-overrides.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "seed-skill-overrides.ps1" file over
#     any co-located "seed-skill-overrides.cmd" sibling -- `seed-skill-overrides` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "seed-skill-overrides.py"
...
$_entry = Join-Path $_here 'seed-skill-overrides.py'
...
[Console]::Error.WriteLine('[seed-skill-overrides] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[seed-skill-overrides] Install Python: https://www.python.org/downloads/windows/')
exit 127
