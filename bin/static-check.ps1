# static-check.ps1 — python-direct Windows launcher for static-check (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "static-check.ps1" file over
#     any co-located "static-check.cmd" sibling -- `static-check` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "static-check"
...
$_entry = Join-Path $_here 'static-check'
...
[Console]::Error.WriteLine('[static-check] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[static-check] Install Python: https://www.python.org/downloads/windows/')
exit 127
