@echo off
setlocal
REM Windows launcher for merge-assemble — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "merge-assemble"
...
:run_baked
"%_py%" "%~dp0merge-assemble" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0merge-assemble" %*
exit /b %ERRORLEVEL%
