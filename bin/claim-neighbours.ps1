# claim-neighbours.ps1 — python-direct Windows launcher for claim-neighbours (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "claim-neighbours.ps1" file over
#     any co-located "claim-neighbours.cmd" sibling -- `claim-neighbours` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "claim-neighbours"
...
$_entry = Join-Path $_here 'claim-neighbours'
...
[Console]::Error.WriteLine('[claim-neighbours] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[claim-neighbours] Install Python: https://www.python.org/downloads/windows/')
exit 127
