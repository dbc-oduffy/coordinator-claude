# render-ceremony-receipt.ps1 — python-direct Windows launcher for render-ceremony-receipt.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "render-ceremony-receipt.ps1" file over
#     any co-located "render-ceremony-receipt.cmd" sibling -- `render-ceremony-receipt` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "render-ceremony-receipt.py"
...
$_entry = Join-Path $_here 'render-ceremony-receipt.py'
...
[Console]::Error.WriteLine('[render-ceremony-receipt] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[render-ceremony-receipt] Install Python: https://www.python.org/downloads/windows/')
exit 127
