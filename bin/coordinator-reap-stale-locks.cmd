@echo off
setlocal
REM Windows launcher for coordinator-reap-stale-locks — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "coordinator-reap-stale-locks"
...
:run_baked
"%_py%" "%~dp0coordinator-reap-stale-locks" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0coordinator-reap-stale-locks" %*
exit /b %ERRORLEVEL%
