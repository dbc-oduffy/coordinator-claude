...
# --- CONSUMERS array ---
# Exact output of:
#   find ~/.claude/plugins/coordinator-claude/{coordinator,data-science,web-dev}/agents \
#        ~/.claude/plugins/example-game-workbench-repo/{example-game-repo-control,game-dev}/agents \
#        -name "*.md" -type f 2>/dev/null | sort
# Note: deep-research agents are now merged into coordinator/agents/ (listed via $_COORD_ROOT below).
...
# Coordinator agents (count via `--list | grep _COORD_ROOT | wc -l`) use $_COORD_ROOT — the resolved content root. When
# Review: code-reviewer — replaced stale "(18 entries)" count with self-describing note to avoid recurring staleness (F5 nit)
...
CONSUMERS=(
    "$HOME/.claude/plugins/example-game-workbench-repo/game-dev/agents/bp-test-evidence-parser.md"
    "$HOME/.claude/plugins/example-game-workbench-repo/game-dev/agents/perf-trace-classifier.md"
    "$HOME/.claude/plugins/example-game-workbench-repo/game-dev/agents/schema-migration-auditor.md"
    "$HOME/.claude/plugins/example-game-workbench-repo/game-dev/agents/staff-game-dev.md"
    "$HOME/.claude/plugins/example-game-workbench-repo/game-dev/agents/ue-blueprint-assembler.md"
    "$HOME/.claude/plugins/example-game-workbench-repo/game-dev/agents/ue-blueprint-worker.md"
    "$HOME/.claude/plugins/example-game-workbench-repo/example-game-repo-control/agents/ue-asset-author.md"
    "$HOME/.claude/plugins/example-game-workbench-repo/example-game-repo-control/agents/ue-cinematic-animator.md"
    "$HOME/.claude/plugins/example-game-workbench-repo/example-game-repo-control/agents/ue-gameplay-engineer.md"
    "$HOME/.claude/plugins/example-game-workbench-repo/example-game-repo-control/agents/ue-infra-engineer.md"
    "$HOME/.claude/plugins/example-game-workbench-repo/example-game-repo-control/agents/ue-project-orchestrator.md"
    "$HOME/.claude/plugins/example-game-workbench-repo/example-game-repo-control/agents/ue-python-executor.md"
    "$HOME/.claude/plugins/example-game-workbench-repo/example-game-repo-control/agents/ue-virtual-production.md"
    "$HOME/.claude/plugins/example-game-workbench-repo/example-game-repo-control/agents/ue-world-builder.md"
    ...
    "$_COORD_ROOT/agents/staff-data-sci.md"
    "$_COORD_ROOT/agents/coverage-auditor.md"
    "$_COORD_ROOT/agents/repo-scout.md"
    "$_COORD_ROOT/agents/repo-specialist.md"
    "$_COORD_ROOT/agents/research-scout.md"
    "$_COORD_ROOT/agents/research-specialist.md"
    "$_COORD_ROOT/agents/research-synthesizer.md"
    "$_COORD_ROOT/agents/structured-synthesizer.md"
    "$_COORD_ROOT/agents/notebooklm-research-scout.md"
    "$_COORD_ROOT/agents/research-sweep.md"
    "$_COORD_ROOT/agents/research-worker.md"
    "$_COORD_ROOT/agents/senior-front-end.md"
    "$_COORD_ROOT/agents/staff-ux.md"
)
