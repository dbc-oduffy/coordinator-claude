@echo off
setlocal
REM Windows launcher for reap-integrated-review-findings.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "reap-integrated-review-findings.ps1" sibling of
REM     this file over this "reap-integrated-review-findings.cmd" file itself -- if both exist, `reap-integrated-review-findings`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "reap-integrated-review-findings.py"
...
echo [reap-integrated-review-findings] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [reap-integrated-review-findings] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0reap-integrated-review-findings.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0reap-integrated-review-findings.py" %*
exit /b %ERRORLEVEL%
