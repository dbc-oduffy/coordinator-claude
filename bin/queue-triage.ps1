# queue-triage.ps1 — python-direct Windows launcher for queue-triage (NO bash re-exec).
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "queue-triage"
...
$_entry = Join-Path $_here 'queue-triage'
