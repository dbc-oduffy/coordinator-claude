# group-em-watch.ps1 — python-direct Windows launcher for group-em-watch (NO bash re-exec).
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "group-em-watch"
...
$_entry = Join-Path $_here 'group-em-watch'
