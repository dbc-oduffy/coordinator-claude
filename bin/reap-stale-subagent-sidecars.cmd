@echo off
setlocal
REM Windows launcher for reap-stale-subagent-sidecars.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "reap-stale-subagent-sidecars.ps1" sibling of
REM     this file over this "reap-stale-subagent-sidecars.cmd" file itself -- if both exist, `reap-stale-subagent-sidecars`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "reap-stale-subagent-sidecars.py"
...
echo [reap-stale-subagent-sidecars] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [reap-stale-subagent-sidecars] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0reap-stale-subagent-sidecars.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0reap-stale-subagent-sidecars.py" %*
exit /b %ERRORLEVEL%
