# uhura-mode.ps1 — python-direct Windows launcher for uhura-mode.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "uhura-mode.ps1" file over
#     any co-located "uhura-mode.cmd" sibling -- `uhura-mode` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "uhura-mode.py"
...
$_entry = Join-Path $_here 'uhura-mode.py'
...
[Console]::Error.WriteLine('[uhura-mode] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[uhura-mode] Install Python: https://www.python.org/downloads/windows/')
exit 127
