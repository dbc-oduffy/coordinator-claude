@echo off
setlocal
REM Windows launcher for consolidate-assemble — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "consolidate-assemble"
...
:run_baked
"%_py%" "%~dp0consolidate-assemble" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0consolidate-assemble" %*
exit /b %ERRORLEVEL%
