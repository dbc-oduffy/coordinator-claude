@echo off
setlocal
REM Windows launcher for coordinator-renormalize-index — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "coordinator-renormalize-index"
...
:run_baked
"%_py%" "%~dp0coordinator-renormalize-index" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0coordinator-renormalize-index" %*
exit /b %ERRORLEVEL%
