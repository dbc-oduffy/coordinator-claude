@echo off
setlocal
REM Windows launcher for plan-tasks-stamp — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "plan-tasks-stamp.ps1" sibling of
REM     this file over this "plan-tasks-stamp.cmd" file itself -- if both exist, `plan-tasks-stamp`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "plan-tasks-stamp"
...
echo [plan-tasks-stamp] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [plan-tasks-stamp] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0plan-tasks-stamp" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0plan-tasks-stamp" %*
exit /b %ERRORLEVEL%
