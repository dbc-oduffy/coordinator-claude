# regenerate-unresolved-writers.ps1 — python-direct Windows launcher for regenerate-unresolved-writers.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "regenerate-unresolved-writers.ps1" file over
#     any co-located "regenerate-unresolved-writers.cmd" sibling -- `regenerate-unresolved-writers` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "regenerate-unresolved-writers.py"
...
$_entry = Join-Path $_here 'regenerate-unresolved-writers.py'
...
[Console]::Error.WriteLine('[regenerate-unresolved-writers] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[regenerate-unresolved-writers] Install Python: https://www.python.org/downloads/windows/')
exit 127
