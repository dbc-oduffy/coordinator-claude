# klabauter-reconcile.ps1 — python-direct Windows launcher for klabauter-reconcile (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "klabauter-reconcile.ps1" file over
#     any co-located "klabauter-reconcile.cmd" sibling -- `klabauter-reconcile` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "klabauter-reconcile"
...
$_entry = Join-Path $_here 'klabauter-reconcile'
...
[Console]::Error.WriteLine('[klabauter-reconcile] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[klabauter-reconcile] Install Python: https://www.python.org/downloads/windows/')
exit 127
