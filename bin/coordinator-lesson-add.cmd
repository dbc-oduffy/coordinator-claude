@echo off
setlocal
REM Windows launcher for coordinator-lesson-add — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "coordinator-lesson-add"
...
:run_baked
"%_py%" "%~dp0coordinator-lesson-add" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0coordinator-lesson-add" %*
exit /b %ERRORLEVEL%
