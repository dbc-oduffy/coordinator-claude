@echo off
setlocal
REM Windows launcher for handoff-housekeeping.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "handoff-housekeeping.ps1" sibling of
REM     this file over this "handoff-housekeeping.cmd" file itself -- if both exist, `handoff-housekeeping`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "handoff-housekeeping.py"
...
echo [handoff-housekeeping] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [handoff-housekeeping] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0handoff-housekeeping.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0handoff-housekeeping.py" %*
exit /b %ERRORLEVEL%
