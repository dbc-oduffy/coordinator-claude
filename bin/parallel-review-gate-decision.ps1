# parallel-review-gate-decision.ps1 — python-direct Windows launcher for parallel-review-gate-decision.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "parallel-review-gate-decision.ps1" file over
#     any co-located "parallel-review-gate-decision.cmd" sibling -- `parallel-review-gate-decision` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "parallel-review-gate-decision.py"
...
$_entry = Join-Path $_here 'parallel-review-gate-decision.py'
...
[Console]::Error.WriteLine('[parallel-review-gate-decision] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[parallel-review-gate-decision] Install Python: https://www.python.org/downloads/windows/')
exit 127
