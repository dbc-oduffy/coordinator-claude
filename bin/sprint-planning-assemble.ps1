# sprint-planning-assemble.ps1 — python-direct Windows launcher for sprint-planning-assemble.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "sprint-planning-assemble.ps1" file over
#     any co-located "sprint-planning-assemble.cmd" sibling -- `sprint-planning-assemble` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "sprint-planning-assemble.py"
...
$_entry = Join-Path $_here 'sprint-planning-assemble.py'
...
[Console]::Error.WriteLine('[sprint-planning-assemble] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[sprint-planning-assemble] Install Python: https://www.python.org/downloads/windows/')
exit 127
