@echo off
setlocal
REM Windows launcher for derive-session-hierarchy — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "derive-session-hierarchy"
...
:run_baked
"%_py%" "%~dp0derive-session-hierarchy" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0derive-session-hierarchy" %*
exit /b %ERRORLEVEL%
