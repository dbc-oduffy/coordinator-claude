@echo off
setlocal
REM Windows launcher for find-polluter.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "find-polluter.ps1" sibling of
REM     this file over this "find-polluter.cmd" file itself -- if both exist, `find-polluter`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "find-polluter.py"
...
echo [find-polluter] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [find-polluter] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0find-polluter.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0find-polluter.py" %*
exit /b %ERRORLEVEL%
