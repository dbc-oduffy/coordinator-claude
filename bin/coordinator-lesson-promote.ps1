# coordinator-lesson-promote.ps1 — python-direct Windows launcher for coordinator-lesson-promote.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "coordinator-lesson-promote.ps1" file over
#     any co-located "coordinator-lesson-promote.cmd" sibling -- `coordinator-lesson-promote` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "coordinator-lesson-promote.py"
...
$_entry = Join-Path $_here 'coordinator-lesson-promote.py'
...
[Console]::Error.WriteLine('[coordinator-lesson-promote] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[coordinator-lesson-promote] Install Python: https://www.python.org/downloads/windows/')
exit 127
