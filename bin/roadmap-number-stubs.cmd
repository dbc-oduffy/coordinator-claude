@echo off
setlocal
REM Windows launcher for roadmap-number-stubs — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "roadmap-number-stubs"
...
:run_baked
"%_py%" "%~dp0roadmap-number-stubs" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0roadmap-number-stubs" %*
exit /b %ERRORLEVEL%
