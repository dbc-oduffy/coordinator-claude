# detect-initiative-candidates.ps1 — python-direct Windows launcher for detect-initiative-candidates.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "detect-initiative-candidates.ps1" file over
#     any co-located "detect-initiative-candidates.cmd" sibling -- `detect-initiative-candidates` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "detect-initiative-candidates.py"
...
$_entry = Join-Path $_here 'detect-initiative-candidates.py'
...
[Console]::Error.WriteLine('[detect-initiative-candidates] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[detect-initiative-candidates] Install Python: https://www.python.org/downloads/windows/')
exit 127
