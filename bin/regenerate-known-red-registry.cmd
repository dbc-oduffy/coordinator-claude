@echo off
setlocal
REM Windows launcher for regenerate-known-red-registry.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "regenerate-known-red-registry.ps1" sibling of
REM     this file over this "regenerate-known-red-registry.cmd" file itself -- if both exist, `regenerate-known-red-registry`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "regenerate-known-red-registry.py"
...
echo [regenerate-known-red-registry] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [regenerate-known-red-registry] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0regenerate-known-red-registry.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0regenerate-known-red-registry.py" %*
exit /b %ERRORLEVEL%
