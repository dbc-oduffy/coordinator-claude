# percolate-liveops-preflight.ps1 — python-direct Windows launcher for percolate-liveops-preflight.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "percolate-liveops-preflight.ps1" file over
#     any co-located "percolate-liveops-preflight.cmd" sibling -- `percolate-liveops-preflight` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "percolate-liveops-preflight.py"
...
$_entry = Join-Path $_here 'percolate-liveops-preflight.py'
...
[Console]::Error.WriteLine('[percolate-liveops-preflight] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[percolate-liveops-preflight] Install Python: https://www.python.org/downloads/windows/')
exit 127
