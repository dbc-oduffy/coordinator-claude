@echo off
setlocal
REM Windows launcher for scan_unresolved_ubt_records.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "scan_unresolved_ubt_records.ps1" sibling of
REM     this file over this "scan_unresolved_ubt_records.cmd" file itself -- if both exist, `scan_unresolved_ubt_records`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "scan_unresolved_ubt_records.py"
...
echo [scan_unresolved_ubt_records] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [scan_unresolved_ubt_records] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0scan_unresolved_ubt_records.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0scan_unresolved_ubt_records.py" %*
exit /b %ERRORLEVEL%
