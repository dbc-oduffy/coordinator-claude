# host-gpu-probe.ps1 — python-direct Windows launcher for host-gpu-probe.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "host-gpu-probe.ps1" file over
#     any co-located "host-gpu-probe.cmd" sibling -- `host-gpu-probe` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "host-gpu-probe.py"
...
$_entry = Join-Path $_here 'host-gpu-probe.py'
...
[Console]::Error.WriteLine('[host-gpu-probe] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[host-gpu-probe] Install Python: https://www.python.org/downloads/windows/')
exit 127
