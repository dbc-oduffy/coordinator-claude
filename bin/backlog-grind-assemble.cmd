@echo off
setlocal
REM Windows launcher for backlog-grind-assemble — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "backlog-grind-assemble"
...
:run_baked
"%_py%" "%~dp0backlog-grind-assemble" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0backlog-grind-assemble" %*
exit /b %ERRORLEVEL%
