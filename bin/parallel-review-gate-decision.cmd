@echo off
setlocal
REM Windows launcher for parallel-review-gate-decision.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "parallel-review-gate-decision.ps1" sibling of
REM     this file over this "parallel-review-gate-decision.cmd" file itself -- if both exist, `parallel-review-gate-decision`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "parallel-review-gate-decision.py"
...
echo [parallel-review-gate-decision] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [parallel-review-gate-decision] Install Python: https://www.python.org/downloads/windows/ 1>&2
...
:run_baked
"%_py%" "%~dp0parallel-review-gate-decision.py" %*
2>nul rd /s /q "%_LAUNCHER_RAW_CMDLINE_DIR%"
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0parallel-review-gate-decision.py" %*
2>nul rd /s /q "%_LAUNCHER_RAW_CMDLINE_DIR%"
exit /b %ERRORLEVEL%
