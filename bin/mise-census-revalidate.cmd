@echo off
setlocal
REM Windows launcher for mise-census-revalidate.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "mise-census-revalidate.ps1" sibling of
REM     this file over this "mise-census-revalidate.cmd" file itself -- if both exist, `mise-census-revalidate`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "mise-census-revalidate.py"
...
echo [mise-census-revalidate] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [mise-census-revalidate] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0mise-census-revalidate.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0mise-census-revalidate.py" %*
exit /b %ERRORLEVEL%
