@echo off
setlocal
REM Windows launcher for coordinator-safe-name — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "coordinator-safe-name"
...
:run_baked
"%_py%" "%~dp0coordinator-safe-name" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0coordinator-safe-name" %*
exit /b %ERRORLEVEL%
