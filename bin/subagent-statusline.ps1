# subagent-statusline.ps1 — python-direct Windows launcher for subagent-statusline.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "subagent-statusline.ps1" file over
#     any co-located "subagent-statusline.cmd" sibling -- `subagent-statusline` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "subagent-statusline.py"
...
$_entry = Join-Path $_here 'subagent-statusline.py'
...
[Console]::Error.WriteLine('[subagent-statusline] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[subagent-statusline] Install Python: https://www.python.org/downloads/windows/')
exit 127
