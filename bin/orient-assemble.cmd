@echo off
setlocal
REM Windows launcher for orient-assemble — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "orient-assemble"
...
:run_baked
"%_py%" "%~dp0orient-assemble" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0orient-assemble" %*
exit /b %ERRORLEVEL%
