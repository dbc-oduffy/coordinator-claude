@echo off
setlocal
REM Windows launcher for goal-assessment-staleness.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "goal-assessment-staleness.ps1" sibling of
REM     this file over this "goal-assessment-staleness.cmd" file itself -- if both exist, `goal-assessment-staleness`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "goal-assessment-staleness.py"
...
echo [goal-assessment-staleness] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [goal-assessment-staleness] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0goal-assessment-staleness.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0goal-assessment-staleness.py" %*
exit /b %ERRORLEVEL%
