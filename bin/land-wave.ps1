# land-wave.ps1 — python-direct Windows launcher for land-wave.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "land-wave.ps1" file over
#     any co-located "land-wave.cmd" sibling -- `land-wave` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "land-wave.py"
...
$_entry = Join-Path $_here 'land-wave.py'
...
[Console]::Error.WriteLine('[land-wave] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[land-wave] Install Python: https://www.python.org/downloads/windows/')
exit 127
