# fleet-env.ps1 — python-direct Windows launcher for fleet-env.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "fleet-env.ps1" file over
#     any co-located "fleet-env.cmd" sibling -- `fleet-env` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "fleet-env.py"
...
$_entry = Join-Path $_here 'fleet-env.py'
...
[Console]::Error.WriteLine('[fleet-env] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[fleet-env] Install Python: https://www.python.org/downloads/windows/')
exit 127
