# review-assemble.ps1 — python-direct Windows launcher for review-assemble.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "review-assemble.ps1" file over
#     any co-located "review-assemble.cmd" sibling -- `review-assemble` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "review-assemble.py"
...
$_entry = Join-Path $_here 'review-assemble.py'
...
[Console]::Error.WriteLine('[review-assemble] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[review-assemble] Install Python: https://www.python.org/downloads/windows/')
exit 127
