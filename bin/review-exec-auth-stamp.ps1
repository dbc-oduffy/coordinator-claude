# review-exec-auth-stamp.ps1 — python-direct Windows launcher for review-exec-auth-stamp.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "review-exec-auth-stamp.ps1" file over
#     any co-located "review-exec-auth-stamp.cmd" sibling -- `review-exec-auth-stamp` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "review-exec-auth-stamp.py"
...
$_entry = Join-Path $_here 'review-exec-auth-stamp.py'
...
[Console]::Error.WriteLine('[review-exec-auth-stamp] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[review-exec-auth-stamp] Install Python: https://www.python.org/downloads/windows/')
exit 127
