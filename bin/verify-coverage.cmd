@echo off
setlocal
REM Windows launcher for verify-coverage — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "verify-coverage"
...
:run_baked
"%_py%" "%~dp0verify-coverage" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0verify-coverage" %*
exit /b %ERRORLEVEL%
