@echo off
setlocal
REM Windows launcher for detect-initiative-candidates.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "detect-initiative-candidates.ps1" sibling of
REM     this file over this "detect-initiative-candidates.cmd" file itself -- if both exist, `detect-initiative-candidates`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "detect-initiative-candidates.py"
...
echo [detect-initiative-candidates] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [detect-initiative-candidates] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0detect-initiative-candidates.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0detect-initiative-candidates.py" %*
exit /b %ERRORLEVEL%
