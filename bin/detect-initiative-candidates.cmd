@echo off
setlocal
REM Windows launcher for detect-initiative-candidates — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "detect-initiative-candidates"
...
:run_baked
"%_py%" "%~dp0detect-initiative-candidates" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0detect-initiative-candidates" %*
exit /b %ERRORLEVEL%
