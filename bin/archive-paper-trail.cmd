@echo off
setlocal
REM Windows launcher for archive-paper-trail.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "archive-paper-trail.ps1" sibling of
REM     this file over this "archive-paper-trail.cmd" file itself -- if both exist, `archive-paper-trail`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "archive-paper-trail.py"
...
echo [archive-paper-trail] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [archive-paper-trail] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0archive-paper-trail.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0archive-paper-trail.py" %*
exit /b %ERRORLEVEL%
