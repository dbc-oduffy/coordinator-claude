@echo off
setlocal
REM Windows launcher for schema-drift-gate — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "schema-drift-gate"
...
:run_baked
"%_py%" "%~dp0schema-drift-gate" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0schema-drift-gate" %*
exit /b %ERRORLEVEL%
