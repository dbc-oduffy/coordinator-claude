@echo off
setlocal
REM Windows launcher for regenerate-unresolved-writers.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "regenerate-unresolved-writers.ps1" sibling of
REM     this file over this "regenerate-unresolved-writers.cmd" file itself -- if both exist, `regenerate-unresolved-writers`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "regenerate-unresolved-writers.py"
...
echo [regenerate-unresolved-writers] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [regenerate-unresolved-writers] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0regenerate-unresolved-writers.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0regenerate-unresolved-writers.py" %*
exit /b %ERRORLEVEL%
