# baton-assemble.ps1 — python-direct Windows launcher for baton-assemble.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "baton-assemble.ps1" file over
#     any co-located "baton-assemble.cmd" sibling -- `baton-assemble` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "baton-assemble.py"
...
$_entry = Join-Path $_here 'baton-assemble.py'
...
[Console]::Error.WriteLine('[baton-assemble] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[baton-assemble] Install Python: https://www.python.org/downloads/windows/')
exit 127
