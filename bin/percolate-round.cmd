@echo off
setlocal
REM Windows launcher for percolate-round.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "percolate-round.ps1" sibling of
REM     this file over this "percolate-round.cmd" file itself -- if both exist, `percolate-round`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "percolate-round.py"
...
echo [percolate-round] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [percolate-round] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0percolate-round.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0percolate-round.py" %*
exit /b %ERRORLEVEL%
