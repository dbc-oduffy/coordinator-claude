# check-description-length.ps1 — python-direct Windows launcher for check-description-length.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "check-description-length.ps1" file over
#     any co-located "check-description-length.cmd" sibling -- `check-description-length` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "check-description-length.py"
...
$_entry = Join-Path $_here 'check-description-length.py'
...
[Console]::Error.WriteLine('[check-description-length] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[check-description-length] Install Python: https://www.python.org/downloads/windows/')
exit 127
