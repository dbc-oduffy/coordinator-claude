@echo off
setlocal
REM Windows launcher for static-check — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "static-check.ps1" sibling of
REM     this file over this "static-check.cmd" file itself -- if both exist, `static-check`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "static-check"
...
echo [static-check] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [static-check] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
