# archive-stamp-cli.ps1 — python-direct Windows launcher for archive-stamp-cli.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "archive-stamp-cli.ps1" file over
#     any co-located "archive-stamp-cli.cmd" sibling -- `archive-stamp-cli` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "archive-stamp-cli.py"
...
$_entry = Join-Path $_here 'archive-stamp-cli.py'
...
[Console]::Error.WriteLine('[archive-stamp-cli] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[archive-stamp-cli] Install Python: https://www.python.org/downloads/windows/')
exit 127
