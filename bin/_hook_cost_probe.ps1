# _hook_cost_probe.ps1 — python-direct Windows launcher for _hook_cost_probe.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "_hook_cost_probe.ps1" file over
#     any co-located "_hook_cost_probe.cmd" sibling -- `_hook_cost_probe` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "_hook_cost_probe.py"
