@echo off
setlocal
REM Windows launcher for emit-artifact-shape-contract — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "emit-artifact-shape-contract"
...
:run_baked
"%_py%" "%~dp0emit-artifact-shape-contract" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0emit-artifact-shape-contract" %*
exit /b %ERRORLEVEL%
