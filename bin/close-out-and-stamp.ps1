# close-out-and-stamp.ps1 — python-direct Windows launcher for close-out-and-stamp.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "close-out-and-stamp.ps1" file over
#     any co-located "close-out-and-stamp.cmd" sibling -- `close-out-and-stamp` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "close-out-and-stamp.py"
...
$_entry = Join-Path $_here 'close-out-and-stamp.py'
...
[Console]::Error.WriteLine('[close-out-and-stamp] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[close-out-and-stamp] Install Python: https://www.python.org/downloads/windows/')
exit 127
