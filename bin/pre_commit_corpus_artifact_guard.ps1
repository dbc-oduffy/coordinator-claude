# pre_commit_corpus_artifact_guard.ps1 — python-direct Windows launcher for pre_commit_corpus_artifact_guard.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "pre_commit_corpus_artifact_guard.ps1" file over
#     any co-located "pre_commit_corpus_artifact_guard.cmd" sibling -- `pre_commit_corpus_artifact_guard` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "pre_commit_corpus_artifact_guard.py"
...
$_entry = Join-Path $_here 'pre_commit_corpus_artifact_guard.py'
...
[Console]::Error.WriteLine('[pre_commit_corpus_artifact_guard] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[pre_commit_corpus_artifact_guard] Install Python: https://www.python.org/downloads/windows/')
exit 127
