# cruft-sweep.ps1 — python-direct Windows launcher for cruft-sweep.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "cruft-sweep.ps1" file over
#     any co-located "cruft-sweep.cmd" sibling -- `cruft-sweep` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "cruft-sweep.py"
...
$_entry = Join-Path $_here 'cruft-sweep.py'
...
[Console]::Error.WriteLine('[cruft-sweep] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[cruft-sweep] Install Python: https://www.python.org/downloads/windows/')
exit 127
