...
# ---------------------------------------------------------------------------
# Rule 5 — H3 status-closure block (THE BIG ONE for example-game-repo bug-backlog)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
run_case "Rule 6: example-sim-repo-shape strikethrough row dropped" "bug-backlog.md" \
