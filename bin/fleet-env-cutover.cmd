@echo off
setlocal
REM Windows launcher for fleet-env-cutover.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "fleet-env-cutover.ps1" sibling of
REM     this file over this "fleet-env-cutover.cmd" file itself -- if both exist, `fleet-env-cutover`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "fleet-env-cutover.py"
...
echo [fleet-env-cutover] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [fleet-env-cutover] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0fleet-env-cutover.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0fleet-env-cutover.py" %*
exit /b %ERRORLEVEL%
