@echo off
setlocal
REM Windows launcher for coordinator-configure-git — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "coordinator-configure-git"
...
:run_baked
"%_py%" "%~dp0coordinator-configure-git" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0coordinator-configure-git" %*
exit /b %ERRORLEVEL%
