# freeze-review-diff.ps1 — python-direct Windows launcher for freeze-review-diff.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "freeze-review-diff.ps1" file over
#     any co-located "freeze-review-diff.cmd" sibling -- `freeze-review-diff` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "freeze-review-diff.py"
...
$_entry = Join-Path $_here 'freeze-review-diff.py'
...
[Console]::Error.WriteLine('[freeze-review-diff] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[freeze-review-diff] Install Python: https://www.python.org/downloads/windows/')
exit 127
