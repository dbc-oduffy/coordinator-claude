@echo off
setlocal
REM Windows launcher for handoff-deliverable-carry.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "handoff-deliverable-carry.ps1" sibling of
REM     this file over this "handoff-deliverable-carry.cmd" file itself -- if both exist, `handoff-deliverable-carry`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "handoff-deliverable-carry.py"
...
echo [handoff-deliverable-carry] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [handoff-deliverable-carry] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0handoff-deliverable-carry.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0handoff-deliverable-carry.py" %*
exit /b %ERRORLEVEL%
