@echo off
setlocal
REM Windows launcher for append-integrator-dispositions.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "append-integrator-dispositions.ps1" sibling of
REM     this file over this "append-integrator-dispositions.cmd" file itself -- if both exist, `append-integrator-dispositions`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "append-integrator-dispositions.py"
...
echo [append-integrator-dispositions] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [append-integrator-dispositions] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0append-integrator-dispositions.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0append-integrator-dispositions.py" %*
exit /b %ERRORLEVEL%
