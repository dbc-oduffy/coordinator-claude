# regenerate-orientation-cache.ps1 — python-direct Windows launcher for regenerate-orientation-cache.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "regenerate-orientation-cache.ps1" file over
#     any co-located "regenerate-orientation-cache.cmd" sibling -- `regenerate-orientation-cache` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "regenerate-orientation-cache.py"
...
$_entry = Join-Path $_here 'regenerate-orientation-cache.py'
...
[Console]::Error.WriteLine('[regenerate-orientation-cache] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[regenerate-orientation-cache] Install Python: https://www.python.org/downloads/windows/')
exit 127
