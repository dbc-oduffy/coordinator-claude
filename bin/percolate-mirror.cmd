@echo off
setlocal
REM Windows launcher for percolate-mirror.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "percolate-mirror.ps1" sibling of
REM     this file over this "percolate-mirror.cmd" file itself -- if both exist, `percolate-mirror`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "percolate-mirror.py"
...
echo [percolate-mirror] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [percolate-mirror] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0percolate-mirror.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0percolate-mirror.py" %*
exit /b %ERRORLEVEL%
