# regenerate-known-red-registry.ps1 — python-direct Windows launcher for regenerate-known-red-registry.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "regenerate-known-red-registry.ps1" file over
#     any co-located "regenerate-known-red-registry.cmd" sibling -- `regenerate-known-red-registry` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "regenerate-known-red-registry.py"
...
$_entry = Join-Path $_here 'regenerate-known-red-registry.py'
...
[Console]::Error.WriteLine('[regenerate-known-red-registry] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[regenerate-known-red-registry] Install Python: https://www.python.org/downloads/windows/')
exit 127
