@echo off
setlocal
REM Windows launcher for seed-skill-overrides.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "seed-skill-overrides.ps1" sibling of
REM     this file over this "seed-skill-overrides.cmd" file itself -- if both exist, `seed-skill-overrides`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "seed-skill-overrides.py"
...
echo [seed-skill-overrides] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [seed-skill-overrides] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0seed-skill-overrides.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0seed-skill-overrides.py" %*
exit /b %ERRORLEVEL%
