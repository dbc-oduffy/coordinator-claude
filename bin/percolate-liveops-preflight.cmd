@echo off
setlocal
REM Windows launcher for percolate-liveops-preflight.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "percolate-liveops-preflight.ps1" sibling of
REM     this file over this "percolate-liveops-preflight.cmd" file itself -- if both exist, `percolate-liveops-preflight`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "percolate-liveops-preflight.py"
...
echo [percolate-liveops-preflight] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [percolate-liveops-preflight] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0percolate-liveops-preflight.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0percolate-liveops-preflight.py" %*
exit /b %ERRORLEVEL%
