@echo off
setlocal
REM Windows launcher for coordinator-queue-append — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "coordinator-queue-append"
...
:run_baked
"%_py%" "%~dp0coordinator-queue-append" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0coordinator-queue-append" %*
exit /b %ERRORLEVEL%
