@echo off
setlocal
REM Windows launcher for export-catering-resolution.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "export-catering-resolution.ps1" sibling of
REM     this file over this "export-catering-resolution.cmd" file itself -- if both exist, `export-catering-resolution`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "export-catering-resolution.py"
...
echo [export-catering-resolution] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [export-catering-resolution] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0export-catering-resolution.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0export-catering-resolution.py" %*
exit /b %ERRORLEVEL%
