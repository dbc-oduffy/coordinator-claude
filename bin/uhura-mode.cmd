@echo off
setlocal
REM Windows launcher for uhura-mode.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "uhura-mode.ps1" sibling of
REM     this file over this "uhura-mode.cmd" file itself -- if both exist, `uhura-mode`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "uhura-mode.py"
...
echo [uhura-mode] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [uhura-mode] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0uhura-mode.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0uhura-mode.py" %*
exit /b %ERRORLEVEL%
