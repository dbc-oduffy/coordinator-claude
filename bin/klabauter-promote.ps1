# klabauter-promote.ps1 — python-direct Windows launcher for klabauter-promote.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "klabauter-promote.ps1" file over
#     any co-located "klabauter-promote.cmd" sibling -- `klabauter-promote` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "klabauter-promote.py"
...
$_entry = Join-Path $_here 'klabauter-promote.py'
...
[Console]::Error.WriteLine('[klabauter-promote] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[klabauter-promote] Install Python: https://www.python.org/downloads/windows/')
exit 127
