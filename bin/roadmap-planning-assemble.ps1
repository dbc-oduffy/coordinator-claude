# roadmap-planning-assemble.ps1 — python-direct Windows launcher for roadmap-planning-assemble.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "roadmap-planning-assemble.ps1" file over
#     any co-located "roadmap-planning-assemble.cmd" sibling -- `roadmap-planning-assemble` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "roadmap-planning-assemble.py"
...
$_entry = Join-Path $_here 'roadmap-planning-assemble.py'
...
[Console]::Error.WriteLine('[roadmap-planning-assemble] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[roadmap-planning-assemble] Install Python: https://www.python.org/downloads/windows/')
exit 127
