# export-catering-resolution.ps1 — python-direct Windows launcher for export-catering-resolution.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "export-catering-resolution.ps1" file over
#     any co-located "export-catering-resolution.cmd" sibling -- `export-catering-resolution` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "export-catering-resolution.py"
...
$_entry = Join-Path $_here 'export-catering-resolution.py'
...
[Console]::Error.WriteLine('[export-catering-resolution] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[export-catering-resolution] Install Python: https://www.python.org/downloads/windows/')
exit 127
