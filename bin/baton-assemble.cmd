@echo off
setlocal
REM Windows launcher for baton-assemble — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "baton-assemble"
...
:run_baked
"%_py%" "%~dp0baton-assemble" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0baton-assemble" %*
exit /b %ERRORLEVEL%
