@echo off
setlocal
REM Windows launcher for baton-assemble.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "baton-assemble.ps1" sibling of
REM     this file over this "baton-assemble.cmd" file itself -- if both exist, `baton-assemble`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "baton-assemble.py"
