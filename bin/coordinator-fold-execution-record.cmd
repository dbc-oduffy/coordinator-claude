@echo off
setlocal
REM Windows launcher for coordinator-fold-execution-record — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "coordinator-fold-execution-record"
...
:run_baked
"%_py%" "%~dp0coordinator-fold-execution-record" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0coordinator-fold-execution-record" %*
exit /b %ERRORLEVEL%
