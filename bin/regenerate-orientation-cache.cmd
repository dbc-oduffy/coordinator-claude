@echo off
setlocal
REM Windows launcher for regenerate-orientation-cache — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "regenerate-orientation-cache"
...
:run_baked
"%_py%" "%~dp0regenerate-orientation-cache" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0regenerate-orientation-cache" %*
exit /b %ERRORLEVEL%
