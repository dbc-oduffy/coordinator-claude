# claude-home.ps1 — python-direct Windows launcher for claude-home.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "claude-home.ps1" file over
#     any co-located "claude-home.cmd" sibling -- `claude-home` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "claude-home.py"
...
$_entry = Join-Path $_here 'claude-home.py'
...
[Console]::Error.WriteLine('[claude-home] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[claude-home] Install Python: https://www.python.org/downloads/windows/')
exit 127
