@echo off
setlocal
REM Windows launcher for record-platform-outcome — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "record-platform-outcome"
...
:run_baked
"%_py%" "%~dp0record-platform-outcome" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0record-platform-outcome" %*
exit /b %ERRORLEVEL%
