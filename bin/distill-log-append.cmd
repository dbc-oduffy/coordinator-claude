@echo off
setlocal
REM Windows launcher for distill-log-append.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "distill-log-append.ps1" sibling of
REM     this file over this "distill-log-append.cmd" file itself -- if both exist, `distill-log-append`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "distill-log-append.py"
...
echo [distill-log-append] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [distill-log-append] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0distill-log-append.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0distill-log-append.py" %*
exit /b %ERRORLEVEL%
