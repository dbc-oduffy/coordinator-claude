# klabauter-channel.ps1 — python-direct Windows launcher for klabauter-channel.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "klabauter-channel.ps1" file over
#     any co-located "klabauter-channel.cmd" sibling -- `klabauter-channel` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "klabauter-channel.py"
...
$_entry = Join-Path $_here 'klabauter-channel.py'
...
[Console]::Error.WriteLine('[klabauter-channel] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[klabauter-channel] Install Python: https://www.python.org/downloads/windows/')
exit 127
