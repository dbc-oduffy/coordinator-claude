@echo off
setlocal
REM Windows launcher for percolate-parse-dryrun.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "percolate-parse-dryrun.ps1" sibling of
REM     this file over this "percolate-parse-dryrun.cmd" file itself -- if both exist, `percolate-parse-dryrun`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "percolate-parse-dryrun.py"
...
echo [percolate-parse-dryrun] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [percolate-parse-dryrun] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0percolate-parse-dryrun.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0percolate-parse-dryrun.py" %*
exit /b %ERRORLEVEL%
