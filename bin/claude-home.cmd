@echo off
setlocal
REM Windows launcher for claude-home.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "claude-home.ps1" sibling of
REM     this file over this "claude-home.cmd" file itself -- if both exist, `claude-home`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "claude-home.py"
...
echo [claude-home] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [claude-home] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0claude-home.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0claude-home.py" %*
exit /b %ERRORLEVEL%
