@echo off
setlocal
REM Windows launcher for session-claim-cli — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "session-claim-cli"
...
:run_baked
"%_py%" "%~dp0session-claim-cli" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0session-claim-cli" %*
exit /b %ERRORLEVEL%
