# schema-drift-gate.ps1 — python-direct Windows launcher for schema-drift-gate (NO bash re-exec).
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "schema-drift-gate"
...
$_entry = Join-Path $_here 'schema-drift-gate'
