@echo off
setlocal
REM Windows launcher for workstream-complete-assemble — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "workstream-complete-assemble"
...
:run_baked
"%_py%" "%~dp0workstream-complete-assemble" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0workstream-complete-assemble" %*
exit /b %ERRORLEVEL%
