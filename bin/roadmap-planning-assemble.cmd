@echo off
setlocal
REM Windows launcher for roadmap-planning-assemble.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "roadmap-planning-assemble.ps1" sibling of
REM     this file over this "roadmap-planning-assemble.cmd" file itself -- if both exist, `roadmap-planning-assemble`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "roadmap-planning-assemble.py"
...
echo [roadmap-planning-assemble] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [roadmap-planning-assemble] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0roadmap-planning-assemble.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0roadmap-planning-assemble.py" %*
exit /b %ERRORLEVEL%
