# resolve-session-address.ps1 — python-direct Windows launcher for resolve-session-address (NO bash re-exec).
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "resolve-session-address"
...
$_entry = Join-Path $_here 'resolve-session-address'
