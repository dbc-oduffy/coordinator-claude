 ...
 *
 * Design decision D4 (archive/specs/2026-06/2026-06-25-example-initiative-tc-4-fleet-machinery-contract-emit.md § D4):
 ...
 *   (state/handoffs/2026-06-24_075121_structured-handoff-schema-for-cockpit.md) planning to
 *   build a second corpus validator — the Ask-2 AC5 is satisfied by this wrapper. Don't fork.
 *
 * Spec backlink: archive/specs/2026-06/2026-06-25-example-initiative-tc-4-fleet-machinery-contract-emit.md § Chunk A3b / AC5
 *
 * Usage:
 ...
 *
 * @module — CLI-only wrapper; no exports. For programmatic use, import validateAllRecords
 *   from query-records.js (the SSOT for corpus validation per D4 above).
 *   Review: code-reviewer F9 — added to prevent future authors from adding a duplicate
 *   validateHandoff() export here instead of using the SSOT function.
 */
