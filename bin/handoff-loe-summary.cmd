@echo off
setlocal
REM Windows launcher for handoff-loe-summary.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "handoff-loe-summary.ps1" sibling of
REM     this file over this "handoff-loe-summary.cmd" file itself -- if both exist, `handoff-loe-summary`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "handoff-loe-summary.py"
...
echo [handoff-loe-summary] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [handoff-loe-summary] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0handoff-loe-summary.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0handoff-loe-summary.py" %*
exit /b %ERRORLEVEL%
