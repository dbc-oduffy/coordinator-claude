@echo off
setlocal
REM Windows launcher for derive-file-attribution.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "derive-file-attribution.ps1" sibling of
REM     this file over this "derive-file-attribution.cmd" file itself -- if both exist, `derive-file-attribution`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "derive-file-attribution.py"
...
echo [derive-file-attribution] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [derive-file-attribution] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0derive-file-attribution.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0derive-file-attribution.py" %*
exit /b %ERRORLEVEL%
