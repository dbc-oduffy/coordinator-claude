# roadmap-number-stubs.ps1 — python-direct Windows launcher for roadmap-number-stubs.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "roadmap-number-stubs.ps1" file over
#     any co-located "roadmap-number-stubs.cmd" sibling -- `roadmap-number-stubs` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "roadmap-number-stubs.py"
...
$_entry = Join-Path $_here 'roadmap-number-stubs.py'
...
[Console]::Error.WriteLine('[roadmap-number-stubs] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[roadmap-number-stubs] Install Python: https://www.python.org/downloads/windows/')
exit 127
