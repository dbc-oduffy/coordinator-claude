@echo off
setlocal
REM Windows launcher for install-sentinel-write — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "install-sentinel-write"
...
:run_baked
"%_py%" "%~dp0install-sentinel-write" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0install-sentinel-write" %*
exit /b %ERRORLEVEL%
