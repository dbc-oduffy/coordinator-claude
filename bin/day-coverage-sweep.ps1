# day-coverage-sweep.ps1 — python-direct Windows launcher for day-coverage-sweep.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "day-coverage-sweep.ps1" file over
#     any co-located "day-coverage-sweep.cmd" sibling -- `day-coverage-sweep` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "day-coverage-sweep.py"
...
$_entry = Join-Path $_here 'day-coverage-sweep.py'
...
[Console]::Error.WriteLine('[day-coverage-sweep] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[day-coverage-sweep] Install Python: https://www.python.org/downloads/windows/')
exit 127
