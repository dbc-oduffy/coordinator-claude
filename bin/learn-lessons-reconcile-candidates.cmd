@echo off
setlocal
REM Windows launcher for learn-lessons-reconcile-candidates — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "learn-lessons-reconcile-candidates"
...
:run_baked
"%_py%" "%~dp0learn-lessons-reconcile-candidates" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0learn-lessons-reconcile-candidates" %*
exit /b %ERRORLEVEL%
