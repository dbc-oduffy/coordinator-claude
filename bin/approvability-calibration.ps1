# approvability-calibration.ps1 — python-direct Windows launcher for approvability-calibration.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "approvability-calibration.ps1" file over
#     any co-located "approvability-calibration.cmd" sibling -- `approvability-calibration` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "approvability-calibration.py"
...
$_entry = Join-Path $_here 'approvability-calibration.py'
...
[Console]::Error.WriteLine('[approvability-calibration] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[approvability-calibration] Install Python: https://www.python.org/downloads/windows/')
exit 127
