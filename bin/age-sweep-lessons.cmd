@echo off
setlocal
REM Windows launcher for age-sweep-lessons.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "age-sweep-lessons.ps1" sibling of
REM     this file over this "age-sweep-lessons.cmd" file itself -- if both exist, `age-sweep-lessons`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "age-sweep-lessons.py"
...
echo [age-sweep-lessons] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [age-sweep-lessons] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0age-sweep-lessons.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0age-sweep-lessons.py" %*
exit /b %ERRORLEVEL%
