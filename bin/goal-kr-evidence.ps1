# goal-kr-evidence.ps1 — python-direct Windows launcher for goal-kr-evidence.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "goal-kr-evidence.ps1" file over
#     any co-located "goal-kr-evidence.cmd" sibling -- `goal-kr-evidence` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "goal-kr-evidence.py"
