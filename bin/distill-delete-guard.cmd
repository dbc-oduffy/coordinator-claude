@echo off
setlocal
REM Windows launcher for distill-delete-guard.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "distill-delete-guard.ps1" sibling of
REM     this file over this "distill-delete-guard.cmd" file itself -- if both exist, `distill-delete-guard`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "distill-delete-guard.py"
...
echo [distill-delete-guard] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [distill-delete-guard] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0distill-delete-guard.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0distill-delete-guard.py" %*
exit /b %ERRORLEVEL%
