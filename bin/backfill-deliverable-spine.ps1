# backfill-deliverable-spine.ps1 — python-direct Windows launcher for backfill-deliverable-spine.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "backfill-deliverable-spine.ps1" file over
#     any co-located "backfill-deliverable-spine.cmd" sibling -- `backfill-deliverable-spine` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "backfill-deliverable-spine.py"
...
$_entry = Join-Path $_here 'backfill-deliverable-spine.py'
...
[Console]::Error.WriteLine('[backfill-deliverable-spine] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[backfill-deliverable-spine] Install Python: https://www.python.org/downloads/windows/')
exit 127
