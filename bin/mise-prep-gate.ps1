# mise-prep-gate.ps1 — python-direct Windows launcher for mise-prep-gate.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "mise-prep-gate.ps1" file over
#     any co-located "mise-prep-gate.cmd" sibling -- `mise-prep-gate` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "mise-prep-gate.py"
...
$_entry = Join-Path $_here 'mise-prep-gate.py'
...
[Console]::Error.WriteLine('[mise-prep-gate] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[mise-prep-gate] Install Python: https://www.python.org/downloads/windows/')
exit 127
