@echo off
setlocal
REM Windows launcher for klabauter-reconcile — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "klabauter-reconcile.ps1" sibling of
REM     this file over this "klabauter-reconcile.cmd" file itself -- if both exist, `klabauter-reconcile`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "klabauter-reconcile"
...
echo [klabauter-reconcile] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [klabauter-reconcile] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0klabauter-reconcile" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0klabauter-reconcile" %*
exit /b %ERRORLEVEL%
