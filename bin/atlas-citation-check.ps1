# atlas-citation-check.ps1 — python-direct Windows launcher for atlas-citation-check.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "atlas-citation-check.ps1" file over
#     any co-located "atlas-citation-check.cmd" sibling -- `atlas-citation-check` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "atlas-citation-check.py"
...
$_entry = Join-Path $_here 'atlas-citation-check.py'
...
[Console]::Error.WriteLine('[atlas-citation-check] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[atlas-citation-check] Install Python: https://www.python.org/downloads/windows/')
exit 127
