@echo off
setlocal
REM Windows launcher for percolate-preflight-scratch-publish.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "percolate-preflight-scratch-publish.ps1" sibling of
REM     this file over this "percolate-preflight-scratch-publish.cmd" file itself -- if both exist, `percolate-preflight-scratch-publish`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "percolate-preflight-scratch-publish.py"
...
echo [percolate-preflight-scratch-publish] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [percolate-preflight-scratch-publish] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0percolate-preflight-scratch-publish.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0percolate-preflight-scratch-publish.py" %*
exit /b %ERRORLEVEL%
