# measure-loopback-round-trip.ps1 — python-direct Windows launcher for measure-loopback-round-trip.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "measure-loopback-round-trip.ps1" file over
#     any co-located "measure-loopback-round-trip.cmd" sibling -- `measure-loopback-round-trip` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "measure-loopback-round-trip.py"
...
$_entry = Join-Path $_here 'measure-loopback-round-trip.py'
...
[Console]::Error.WriteLine('[measure-loopback-round-trip] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[measure-loopback-round-trip] Install Python: https://www.python.org/downloads/windows/')
exit 127
