@echo off
setlocal
REM Windows launcher for identity-cli — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "identity-cli"
