@echo off
setlocal
REM Windows launcher for verify-snippet-registry-consistency — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "verify-snippet-registry-consistency"
...
:run_baked
"%_py%" "%~dp0verify-snippet-registry-consistency" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0verify-snippet-registry-consistency" %*
exit /b %ERRORLEVEL%
