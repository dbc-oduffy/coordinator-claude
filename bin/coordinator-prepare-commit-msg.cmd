@echo off
setlocal
REM Windows launcher for coordinator-prepare-commit-msg — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "coordinator-prepare-commit-msg"
...
:run_baked
"%_py%" "%~dp0coordinator-prepare-commit-msg" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0coordinator-prepare-commit-msg" %*
exit /b %ERRORLEVEL%
