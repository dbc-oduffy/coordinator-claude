# reassess-goal-krs.ps1 — python-direct Windows launcher for reassess-goal-krs.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "reassess-goal-krs.ps1" file over
#     any co-located "reassess-goal-krs.cmd" sibling -- `reassess-goal-krs` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "reassess-goal-krs.py"
...
$_entry = Join-Path $_here 'reassess-goal-krs.py'
...
[Console]::Error.WriteLine('[reassess-goal-krs] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[reassess-goal-krs] Install Python: https://www.python.org/downloads/windows/')
exit 127
