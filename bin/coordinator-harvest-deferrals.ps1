# coordinator-harvest-deferrals.ps1 — python-direct Windows launcher for coordinator-harvest-deferrals.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "coordinator-harvest-deferrals.ps1" file over
#     any co-located "coordinator-harvest-deferrals.cmd" sibling -- `coordinator-harvest-deferrals` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "coordinator-harvest-deferrals.py"
...
$_entry = Join-Path $_here 'coordinator-harvest-deferrals.py'
...
[Console]::Error.WriteLine('[coordinator-harvest-deferrals] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[coordinator-harvest-deferrals] Install Python: https://www.python.org/downloads/windows/')
exit 127
