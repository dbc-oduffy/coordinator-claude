@echo off
setlocal
REM Windows launcher for handoff-carry-gate.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "handoff-carry-gate.ps1" sibling of
REM     this file over this "handoff-carry-gate.cmd" file itself -- if both exist, `handoff-carry-gate`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "handoff-carry-gate.py"
...
echo [handoff-carry-gate] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [handoff-carry-gate] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0handoff-carry-gate.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0handoff-carry-gate.py" %*
exit /b %ERRORLEVEL%
