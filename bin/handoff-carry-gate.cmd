@echo off
setlocal
REM Windows launcher for handoff-carry-gate — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "handoff-carry-gate"
...
:run_baked
"%_py%" "%~dp0handoff-carry-gate" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0handoff-carry-gate" %*
exit /b %ERRORLEVEL%
