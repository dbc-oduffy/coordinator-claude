@echo off
setlocal
REM Windows launcher for coordinator-settings-home — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "coordinator-settings-home"
...
echo [coordinator-settings-home] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [coordinator-settings-home] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127

:run_baked
"%_py%" "%~dp0coordinator-settings-home" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0coordinator-settings-home" %*
exit /b %ERRORLEVEL%
