@echo off
setlocal
REM Windows launcher for workweek-complete-close.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "workweek-complete-close.ps1" sibling of
REM     this file over this "workweek-complete-close.cmd" file itself -- if both exist, `workweek-complete-close`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "workweek-complete-close.py"
...
echo [workweek-complete-close] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [workweek-complete-close] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0workweek-complete-close.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0workweek-complete-close.py" %*
exit /b %ERRORLEVEL%
