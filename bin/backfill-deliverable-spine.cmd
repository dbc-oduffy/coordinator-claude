@echo off
setlocal
REM Windows launcher for backfill-deliverable-spine.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "backfill-deliverable-spine.ps1" sibling of
REM     this file over this "backfill-deliverable-spine.cmd" file itself -- if both exist, `backfill-deliverable-spine`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "backfill-deliverable-spine.py"
...
echo [backfill-deliverable-spine] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [backfill-deliverable-spine] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127

:run_baked
"%_py%" "%~dp0backfill-deliverable-spine.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0backfill-deliverable-spine.py" %*
exit /b %ERRORLEVEL%
