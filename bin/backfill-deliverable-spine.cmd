@echo off
setlocal
REM Windows launcher for backfill-deliverable-spine — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "backfill-deliverable-spine"
...
:run_baked
"%_py%" "%~dp0backfill-deliverable-spine" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0backfill-deliverable-spine" %*
exit /b %ERRORLEVEL%
