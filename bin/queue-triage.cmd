@echo off
setlocal
REM Windows launcher for queue-triage — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "queue-triage"
