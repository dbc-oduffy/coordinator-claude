@echo off
setlocal
REM Windows launcher for coordinator-ensure-prepare-commit-msg-hook — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "coordinator-ensure-prepare-commit-msg-hook"
...
:run_baked
"%_py%" "%~dp0coordinator-ensure-prepare-commit-msg-hook" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0coordinator-ensure-prepare-commit-msg-hook" %*
exit /b %ERRORLEVEL%
