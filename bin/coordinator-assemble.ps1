# coordinator-assemble.ps1 — python-direct Windows launcher for coordinator-assemble.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "coordinator-assemble.ps1" file over
#     any co-located "coordinator-assemble.cmd" sibling -- `coordinator-assemble` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "coordinator-assemble.py"
...
$_entry = Join-Path $_here 'coordinator-assemble.py'
...
[Console]::Error.WriteLine('[coordinator-assemble] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[coordinator-assemble] Install Python: https://www.python.org/downloads/windows/')
exit 127
