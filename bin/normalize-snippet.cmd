@echo off
setlocal
REM Windows launcher for normalize-snippet — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "normalize-snippet"
...
:run_baked
"%_py%" "%~dp0normalize-snippet" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0normalize-snippet" %*
exit /b %ERRORLEVEL%
