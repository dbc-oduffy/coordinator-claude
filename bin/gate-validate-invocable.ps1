# gate-validate-invocable.ps1 — python-direct Windows launcher for gate-validate-invocable (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "gate-validate-invocable.ps1" file over
#     any co-located "gate-validate-invocable.cmd" sibling -- `gate-validate-invocable` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "gate-validate-invocable"
...
$_entry = Join-Path $_here 'gate-validate-invocable'
...
[Console]::Error.WriteLine('[gate-validate-invocable] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[gate-validate-invocable] Install Python: https://www.python.org/downloads/windows/')
exit 127
