# mise-census-revalidate.ps1 — python-direct Windows launcher for mise-census-revalidate.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "mise-census-revalidate.ps1" file over
#     any co-located "mise-census-revalidate.cmd" sibling -- `mise-census-revalidate` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "mise-census-revalidate.py"
...
$_entry = Join-Path $_here 'mise-census-revalidate.py'
...
[Console]::Error.WriteLine('[mise-census-revalidate] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[mise-census-revalidate] Install Python: https://www.python.org/downloads/windows/')
exit 127
