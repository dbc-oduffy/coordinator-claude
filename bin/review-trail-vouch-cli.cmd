@echo off
setlocal
REM Windows launcher for review-trail-vouch-cli — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "review-trail-vouch-cli"
...
echo [review-trail-vouch-cli] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [review-trail-vouch-cli] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127

:run_baked
"%_py%" "%~dp0review-trail-vouch-cli" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0review-trail-vouch-cli" %*
exit /b %ERRORLEVEL%
