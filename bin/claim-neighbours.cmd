@echo off
setlocal
REM Windows launcher for claim-neighbours — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "claim-neighbours.ps1" sibling of
REM     this file over this "claim-neighbours.cmd" file itself -- if both exist, `claim-neighbours`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "claim-neighbours"
...
echo [claim-neighbours] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [claim-neighbours] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0claim-neighbours" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0claim-neighbours" %*
exit /b %ERRORLEVEL%
