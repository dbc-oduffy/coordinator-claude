# claude-doe.ps1 — python-direct Windows launcher for claude-doe.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "claude-doe.ps1" file over
#     any co-located "claude-doe.cmd" sibling -- `claude-doe` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "claude-doe.py"
