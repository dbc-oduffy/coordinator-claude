# consolidate-assemble.ps1 — python-direct Windows launcher for consolidate-assemble.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "consolidate-assemble.ps1" file over
#     any co-located "consolidate-assemble.cmd" sibling -- `consolidate-assemble` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "consolidate-assemble.py"
...
$_entry = Join-Path $_here 'consolidate-assemble.py'
...
[Console]::Error.WriteLine('[consolidate-assemble] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[consolidate-assemble] Install Python: https://www.python.org/downloads/windows/')
exit 127
