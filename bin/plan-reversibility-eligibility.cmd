@echo off
setlocal
REM Windows launcher for plan-reversibility-eligibility.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "plan-reversibility-eligibility.ps1" sibling of
REM     this file over this "plan-reversibility-eligibility.cmd" file itself -- if both exist, `plan-reversibility-eligibility`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "plan-reversibility-eligibility.py"
...
echo [plan-reversibility-eligibility] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [plan-reversibility-eligibility] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0plan-reversibility-eligibility.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0plan-reversibility-eligibility.py" %*
exit /b %ERRORLEVEL%
