# statusline.ps1 — python-direct Windows launcher for statusline.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "statusline.ps1" file over
#     any co-located "statusline.cmd" sibling -- `statusline` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "statusline.py"
...
$_entry = Join-Path $_here 'statusline.py'
...
[Console]::Error.WriteLine('[statusline] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[statusline] Install Python: https://www.python.org/downloads/windows/')
exit 127
