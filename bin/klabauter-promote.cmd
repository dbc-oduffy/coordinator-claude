@echo off
setlocal
REM Windows launcher for klabauter-promote.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "klabauter-promote.ps1" sibling of
REM     this file over this "klabauter-promote.cmd" file itself -- if both exist, `klabauter-promote`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "klabauter-promote.py"
...
echo [klabauter-promote] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [klabauter-promote] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0klabauter-promote.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0klabauter-promote.py" %*
exit /b %ERRORLEVEL%
