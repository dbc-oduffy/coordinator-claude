...
_write_plan "$plan_a" \
'| 1 | C1 | chunk one | file1.sh | none | parallel | 10 | pending |
| 2 | C2 | chunk two | file2.sh | output-consumption-content | parallel | 10 | pending |
| 3 | C3 | chunk three | file3.sh | contract-change | parallel | 10 | pending |'
...
_write_plan "$plan_c" \
'| 1 | C1 | chunk one | file1.sh | file-write-overlap | parallel | 10 | pending |
| 2 | C2 | chunk two | file1.sh | file-write-overlap | parallel | 10 | pending |
| 3 | C3 | chunk three | file1.sh | file-write-overlap | parallel | 10 | pending |'
...
_write_plan "$plan_d" \
'| 1 | C1 | chunk one | file1.sh | none | parallel | 10 | pending |
| 2 | C2 | chunk two | file2.sh | none | inline (EM) | 5 | pending |
| 3 | C3 | chunk three | file3.sh | contract-change | inline (EM) | 5 | pending |'
...
| 2 | C2 | chunk two | file2.sh | output-consumption-content | parallel | 10 | pending |
| 3 | C3 | chunk three | file3.sh | contract-change | parallel | 10 | pending |
| 4 | C4 | inline one | file4.sh | none | inline (EM) | 5 | pending |
| 5 | C5 | inline two | file5.sh | contract-change | inline (EM) | 5 | pending |'
