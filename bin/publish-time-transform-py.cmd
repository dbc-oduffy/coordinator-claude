@echo off
setlocal
REM Windows launcher for publish-time-transform-py — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "publish-time-transform-py"
...
:run_baked
"%_py%" "%~dp0publish-time-transform-py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0publish-time-transform-py" %*
exit /b %ERRORLEVEL%
