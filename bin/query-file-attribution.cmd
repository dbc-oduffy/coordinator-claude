@echo off
setlocal
REM Windows launcher for query-file-attribution.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "query-file-attribution.ps1" sibling of
REM     this file over this "query-file-attribution.cmd" file itself -- if both exist, `query-file-attribution`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "query-file-attribution.py"
...
echo [query-file-attribution] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [query-file-attribution] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0query-file-attribution.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0query-file-attribution.py" %*
exit /b %ERRORLEVEL%
