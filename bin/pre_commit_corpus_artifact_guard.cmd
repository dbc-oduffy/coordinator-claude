@echo off
setlocal
REM Windows launcher for pre_commit_corpus_artifact_guard.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "pre_commit_corpus_artifact_guard.ps1" sibling of
REM     this file over this "pre_commit_corpus_artifact_guard.cmd" file itself -- if both exist, `pre_commit_corpus_artifact_guard`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "pre_commit_corpus_artifact_guard.py"
...
echo [pre_commit_corpus_artifact_guard] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [pre_commit_corpus_artifact_guard] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0pre_commit_corpus_artifact_guard.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0pre_commit_corpus_artifact_guard.py" %*
exit /b %ERRORLEVEL%
