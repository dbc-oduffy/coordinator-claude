# detect-project-runtime.ps1 — python-direct Windows launcher for detect-project-runtime.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "detect-project-runtime.ps1" file over
#     any co-located "detect-project-runtime.cmd" sibling -- `detect-project-runtime` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "detect-project-runtime.py"
...
$_entry = Join-Path $_here 'detect-project-runtime.py'
...
[Console]::Error.WriteLine('[detect-project-runtime] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[detect-project-runtime] Install Python: https://www.python.org/downloads/windows/')
exit 127
