# baton-chain-closure.ps1 — python-direct Windows launcher for baton-chain-closure.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "baton-chain-closure.ps1" file over
#     any co-located "baton-chain-closure.cmd" sibling -- `baton-chain-closure` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "baton-chain-closure.py"
...
$_entry = Join-Path $_here 'baton-chain-closure.py'
...
[Console]::Error.WriteLine('[baton-chain-closure] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[baton-chain-closure] Install Python: https://www.python.org/downloads/windows/')
exit 127
