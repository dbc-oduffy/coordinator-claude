# render-template-tree.ps1 — python-direct Windows launcher for render-template-tree.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "render-template-tree.ps1" file over
#     any co-located "render-template-tree.cmd" sibling -- `render-template-tree` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "render-template-tree.py"
...
$_entry = Join-Path $_here 'render-template-tree.py'
...
[Console]::Error.WriteLine('[render-template-tree] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[render-template-tree] Install Python: https://www.python.org/downloads/windows/')
exit 127
