# goal-assessment-staleness.ps1 — python-direct Windows launcher for goal-assessment-staleness.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "goal-assessment-staleness.ps1" file over
#     any co-located "goal-assessment-staleness.cmd" sibling -- `goal-assessment-staleness` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "goal-assessment-staleness.py"
...
$_entry = Join-Path $_here 'goal-assessment-staleness.py'
...
[Console]::Error.WriteLine('[goal-assessment-staleness] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[goal-assessment-staleness] Install Python: https://www.python.org/downloads/windows/')
exit 127
