@echo off
setlocal
REM Windows launcher for survey-consume-gate.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "survey-consume-gate.ps1" sibling of
REM     this file over this "survey-consume-gate.cmd" file itself -- if both exist, `survey-consume-gate`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "survey-consume-gate.py"
...
echo [survey-consume-gate] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [survey-consume-gate] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0survey-consume-gate.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0survey-consume-gate.py" %*
exit /b %ERRORLEVEL%
