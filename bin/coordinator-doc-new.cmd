@echo off
setlocal
REM Windows launcher for coordinator-doc-new — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "coordinator-doc-new"
...
:run_baked
"%_py%" "%~dp0coordinator-doc-new" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0coordinator-doc-new" %*
exit /b %ERRORLEVEL%
