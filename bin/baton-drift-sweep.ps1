# baton-drift-sweep.ps1 — python-direct Windows launcher for baton-drift-sweep.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "baton-drift-sweep.ps1" file over
#     any co-located "baton-drift-sweep.cmd" sibling -- `baton-drift-sweep` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "baton-drift-sweep.py"
...
$_entry = Join-Path $_here 'baton-drift-sweep.py'
...
[Console]::Error.WriteLine('[baton-drift-sweep] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[baton-drift-sweep] Install Python: https://www.python.org/downloads/windows/')
exit 127
