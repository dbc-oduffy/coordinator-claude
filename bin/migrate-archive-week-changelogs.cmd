@echo off
setlocal
REM Windows launcher for migrate-archive-week-changelogs.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "migrate-archive-week-changelogs.ps1" sibling of
REM     this file over this "migrate-archive-week-changelogs.cmd" file itself -- if both exist, `migrate-archive-week-changelogs`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "migrate-archive-week-changelogs.py"
...
echo [migrate-archive-week-changelogs] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [migrate-archive-week-changelogs] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127

:run_baked
"%_py%" "%~dp0migrate-archive-week-changelogs.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0migrate-archive-week-changelogs.py" %*
exit /b %ERRORLEVEL%
