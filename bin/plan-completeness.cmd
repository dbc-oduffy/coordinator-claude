@echo off
setlocal
REM Windows launcher for plan-completeness — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "plan-completeness.ps1" sibling of
REM     this file over this "plan-completeness.cmd" file itself -- if both exist, `plan-completeness`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "plan-completeness"
...
echo [plan-completeness] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [plan-completeness] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0plan-completeness" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0plan-completeness" %*
exit /b %ERRORLEVEL%
