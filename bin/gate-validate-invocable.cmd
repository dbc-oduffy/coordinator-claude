@echo off
setlocal
REM Windows launcher for gate-validate-invocable — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "gate-validate-invocable.ps1" sibling of
REM     this file over this "gate-validate-invocable.cmd" file itself -- if both exist, `gate-validate-invocable`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "gate-validate-invocable"
...
echo [gate-validate-invocable] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [gate-validate-invocable] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0gate-validate-invocable" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0gate-validate-invocable" %*
exit /b %ERRORLEVEL%
