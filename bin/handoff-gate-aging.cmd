@echo off
setlocal
REM Windows launcher for handoff-gate-aging — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "handoff-gate-aging"
...
:run_baked
"%_py%" "%~dp0handoff-gate-aging" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0handoff-gate-aging" %*
exit /b %ERRORLEVEL%
