@echo off
setlocal
REM Windows launcher for handoff-gate-aging.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "handoff-gate-aging.ps1" sibling of
REM     this file over this "handoff-gate-aging.cmd" file itself -- if both exist, `handoff-gate-aging`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "handoff-gate-aging.py"
...
echo [handoff-gate-aging] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [handoff-gate-aging] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0handoff-gate-aging.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0handoff-gate-aging.py" %*
exit /b %ERRORLEVEL%
