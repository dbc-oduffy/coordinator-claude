@echo off
setlocal
REM Windows launcher for coordinator-initiative — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "coordinator-initiative"
...
:run_baked
"%_py%" "%~dp0coordinator-initiative" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0coordinator-initiative" %*
exit /b %ERRORLEVEL%
