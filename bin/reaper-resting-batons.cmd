@echo off
setlocal
REM Windows launcher for reaper-resting-batons.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "reaper-resting-batons.ps1" sibling of
REM     this file over this "reaper-resting-batons.cmd" file itself -- if both exist, `reaper-resting-batons`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "reaper-resting-batons.py"
...
echo [reaper-resting-batons] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [reaper-resting-batons] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0reaper-resting-batons.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0reaper-resting-batons.py" %*
exit /b %ERRORLEVEL%
