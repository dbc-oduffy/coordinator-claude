@echo off
setlocal
REM Windows launcher for sprint-planning-assemble.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "sprint-planning-assemble.ps1" sibling of
REM     this file over this "sprint-planning-assemble.cmd" file itself -- if both exist, `sprint-planning-assemble`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "sprint-planning-assemble.py"
...
echo [sprint-planning-assemble] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [sprint-planning-assemble] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0sprint-planning-assemble.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0sprint-planning-assemble.py" %*
exit /b %ERRORLEVEL%
