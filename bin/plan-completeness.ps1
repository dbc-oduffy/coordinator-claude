# plan-completeness.ps1 — python-direct Windows launcher for plan-completeness (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "plan-completeness.ps1" file over
#     any co-located "plan-completeness.cmd" sibling -- `plan-completeness` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "plan-completeness"
...
$_entry = Join-Path $_here 'plan-completeness'
...
[Console]::Error.WriteLine('[plan-completeness] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[plan-completeness] Install Python: https://www.python.org/downloads/windows/')
exit 127
