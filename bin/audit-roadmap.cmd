@echo off
setlocal
REM Windows launcher for audit-roadmap.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "audit-roadmap.ps1" sibling of
REM     this file over this "audit-roadmap.cmd" file itself -- if both exist, `audit-roadmap`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "audit-roadmap.py"
...
echo [audit-roadmap] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [audit-roadmap] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0audit-roadmap.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0audit-roadmap.py" %*
exit /b %ERRORLEVEL%
