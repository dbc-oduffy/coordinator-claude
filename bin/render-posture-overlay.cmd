@echo off
setlocal
REM Windows launcher for render-posture-overlay.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "render-posture-overlay.ps1" sibling of
REM     this file over this "render-posture-overlay.cmd" file itself -- if both exist, `render-posture-overlay`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "render-posture-overlay.py"
...
echo [render-posture-overlay] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [render-posture-overlay] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0render-posture-overlay.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0render-posture-overlay.py" %*
exit /b %ERRORLEVEL%
