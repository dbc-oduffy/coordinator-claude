# backlog-grind-assemble.ps1 — python-direct Windows launcher for backlog-grind-assemble.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "backlog-grind-assemble.ps1" file over
#     any co-located "backlog-grind-assemble.cmd" sibling -- `backlog-grind-assemble` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "backlog-grind-assemble.py"
...
$_entry = Join-Path $_here 'backlog-grind-assemble.py'
...
[Console]::Error.WriteLine('[backlog-grind-assemble] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[backlog-grind-assemble] Install Python: https://www.python.org/downloads/windows/')
exit 127
