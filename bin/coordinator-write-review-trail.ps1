# coordinator-write-review-trail.ps1 — python-direct Windows launcher for coordinator-write-review-trail.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "coordinator-write-review-trail.ps1" file over
#     any co-located "coordinator-write-review-trail.cmd" sibling -- `coordinator-write-review-trail` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "coordinator-write-review-trail.py"
...
$_entry = Join-Path $_here 'coordinator-write-review-trail.py'
...
[Console]::Error.WriteLine('[coordinator-write-review-trail] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[coordinator-write-review-trail] Install Python: https://www.python.org/downloads/windows/')
exit 127
