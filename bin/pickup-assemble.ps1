# pickup-assemble.ps1 — python-direct Windows launcher for pickup-assemble.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "pickup-assemble.ps1" file over
#     any co-located "pickup-assemble.cmd" sibling -- `pickup-assemble` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "pickup-assemble.py"
...
$_entry = Join-Path $_here 'pickup-assemble.py'
...
[Console]::Error.WriteLine('[pickup-assemble] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[pickup-assemble] Install Python: https://www.python.org/downloads/windows/')
exit 127
