@echo off
setlocal
REM Windows launcher for group-em-watch — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "group-em-watch"
...
:run_baked
"%_py%" "%~dp0group-em-watch" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0group-em-watch" %*
exit /b %ERRORLEVEL%
