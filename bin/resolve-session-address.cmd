@echo off
setlocal
REM Windows launcher for resolve-session-address — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "resolve-session-address"
...
:run_baked
"%_py%" "%~dp0resolve-session-address" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0resolve-session-address" %*
exit /b %ERRORLEVEL%
