# orient-assemble.ps1 — python-direct Windows launcher for orient-assemble.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "orient-assemble.ps1" file over
#     any co-located "orient-assemble.cmd" sibling -- `orient-assemble` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "orient-assemble.py"
...
$_entry = Join-Path $_here 'orient-assemble.py'
...
[Console]::Error.WriteLine('[orient-assemble] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[orient-assemble] Install Python: https://www.python.org/downloads/windows/')
exit 127
