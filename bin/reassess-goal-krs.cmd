@echo off
setlocal
REM Windows launcher for reassess-goal-krs.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "reassess-goal-krs.ps1" sibling of
REM     this file over this "reassess-goal-krs.cmd" file itself -- if both exist, `reassess-goal-krs`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "reassess-goal-krs.py"
...
echo [reassess-goal-krs] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [reassess-goal-krs] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0reassess-goal-krs.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0reassess-goal-krs.py" %*
exit /b %ERRORLEVEL%
