@echo off
setlocal
REM Windows launcher for reassess-goal-krs — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "reassess-goal-krs"
...
:run_baked
"%_py%" "%~dp0reassess-goal-krs" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0reassess-goal-krs" %*
exit /b %ERRORLEVEL%
