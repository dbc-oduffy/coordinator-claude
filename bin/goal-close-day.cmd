@echo off
setlocal
REM Windows launcher for goal-close-day.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "goal-close-day.ps1" sibling of
REM     this file over this "goal-close-day.cmd" file itself -- if both exist, `goal-close-day`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "goal-close-day.py"
...
echo [goal-close-day] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [goal-close-day] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0goal-close-day.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0goal-close-day.py" %*
exit /b %ERRORLEVEL%
