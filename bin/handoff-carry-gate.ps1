# handoff-carry-gate.ps1 — python-direct Windows launcher for handoff-carry-gate.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "handoff-carry-gate.ps1" file over
#     any co-located "handoff-carry-gate.cmd" sibling -- `handoff-carry-gate` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "handoff-carry-gate.py"
...
$_entry = Join-Path $_here 'handoff-carry-gate.py'
...
[Console]::Error.WriteLine('[handoff-carry-gate] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[handoff-carry-gate] Install Python: https://www.python.org/downloads/windows/')
exit 127
