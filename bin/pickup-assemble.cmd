@echo off
setlocal
REM Windows launcher for pickup-assemble — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "pickup-assemble"
...
:run_baked
"%_py%" "%~dp0pickup-assemble" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0pickup-assemble" %*
exit /b %ERRORLEVEL%
