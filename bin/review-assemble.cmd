@echo off
setlocal
REM Windows launcher for review-assemble — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "review-assemble"
...
:run_baked
"%_py%" "%~dp0review-assemble" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0review-assemble" %*
exit /b %ERRORLEVEL%
