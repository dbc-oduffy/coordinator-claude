@echo off
setlocal
REM Windows launcher for review-assemble.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "review-assemble.ps1" sibling of
REM     this file over this "review-assemble.cmd" file itself -- if both exist, `review-assemble`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "review-assemble.py"
...
echo [review-assemble] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [review-assemble] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0review-assemble.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0review-assemble.py" %*
exit /b %ERRORLEVEL%
