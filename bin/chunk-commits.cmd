@echo off
setlocal
REM Windows launcher for chunk-commits — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "chunk-commits.ps1" sibling of
REM     this file over this "chunk-commits.cmd" file itself -- if both exist, `chunk-commits`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "chunk-commits"
...
echo [chunk-commits] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [chunk-commits] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0chunk-commits" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0chunk-commits" %*
exit /b %ERRORLEVEL%
