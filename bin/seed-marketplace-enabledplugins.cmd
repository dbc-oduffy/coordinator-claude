@echo off
setlocal
REM Windows launcher for seed-marketplace-enabledplugins.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "seed-marketplace-enabledplugins.ps1" sibling of
REM     this file over this "seed-marketplace-enabledplugins.cmd" file itself -- if both exist, `seed-marketplace-enabledplugins`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "seed-marketplace-enabledplugins.py"
...
echo [seed-marketplace-enabledplugins] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [seed-marketplace-enabledplugins] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0seed-marketplace-enabledplugins.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0seed-marketplace-enabledplugins.py" %*
exit /b %ERRORLEVEL%
