@echo off
setlocal
REM Windows launcher for classify-env-var-callers.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "classify-env-var-callers.ps1" sibling of
REM     this file over this "classify-env-var-callers.cmd" file itself -- if both exist, `classify-env-var-callers`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "classify-env-var-callers.py"
...
echo [classify-env-var-callers] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [classify-env-var-callers] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0classify-env-var-callers.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0classify-env-var-callers.py" %*
exit /b %ERRORLEVEL%
