...
same contract as the op's: CLAUDE_KLABAUTER_ROOT unresolvable, and the op module not
...
# NOT be silently swallowed into exit 0 — this trampoline's own CLAUDE_KLABAUTER_ROOT-
...
def main() -> None:
    try:
        ...
        print(
            f"verify-skill-anchor-links: COULD NOT CHECK — CLAUDE_KLABAUTER_ROOT did not resolve, "
        ...
        print(
            f"verify-skill-anchor-links: COULD NOT CHECK — CLAUDE_KLABAUTER_ROOT resolved but "
