@echo off
setlocal
REM Windows launcher for parallel-review-orthogonality-guard.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "parallel-review-orthogonality-guard.ps1" sibling of
REM     this file over this "parallel-review-orthogonality-guard.cmd" file itself -- if both exist, `parallel-review-orthogonality-guard`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "parallel-review-orthogonality-guard.py"
...
echo [parallel-review-orthogonality-guard] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [parallel-review-orthogonality-guard] Install Python: https://www.python.org/downloads/windows/ 1>&2
...
:run_baked
"%_py%" "%~dp0parallel-review-orthogonality-guard.py" %*
2>nul rd /s /q "%_LAUNCHER_RAW_CMDLINE_DIR%"
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0parallel-review-orthogonality-guard.py" %*
2>nul rd /s /q "%_LAUNCHER_RAW_CMDLINE_DIR%"
exit /b %ERRORLEVEL%
