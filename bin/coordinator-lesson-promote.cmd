@echo off
setlocal
REM Windows launcher for coordinator-lesson-promote — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "coordinator-lesson-promote"
...
:run_baked
"%_py%" "%~dp0coordinator-lesson-promote" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0coordinator-lesson-promote" %*
exit /b %ERRORLEVEL%
