@echo off
setlocal
REM Windows launcher for coordinator-lesson-promote.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "coordinator-lesson-promote.ps1" sibling of
REM     this file over this "coordinator-lesson-promote.cmd" file itself -- if both exist, `coordinator-lesson-promote`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "coordinator-lesson-promote.py"
...
echo [coordinator-lesson-promote] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [coordinator-lesson-promote] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0coordinator-lesson-promote.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0coordinator-lesson-promote.py" %*
exit /b %ERRORLEVEL%
