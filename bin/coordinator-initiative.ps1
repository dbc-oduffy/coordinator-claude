# coordinator-initiative.ps1 — python-direct Windows launcher for coordinator-initiative.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "coordinator-initiative.ps1" file over
#     any co-located "coordinator-initiative.cmd" sibling -- `coordinator-initiative` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "coordinator-initiative.py"
...
$_entry = Join-Path $_here 'coordinator-initiative.py'
...
[Console]::Error.WriteLine('[coordinator-initiative] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[coordinator-initiative] Install Python: https://www.python.org/downloads/windows/')
exit 127
