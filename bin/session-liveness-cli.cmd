@echo off
setlocal
REM Windows launcher for session-liveness-cli — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "session-liveness-cli"
...
:run_baked
"%_py%" "%~dp0session-liveness-cli" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0session-liveness-cli" %*
exit /b %ERRORLEVEL%
