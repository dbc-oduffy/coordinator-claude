@echo off
setlocal
REM Windows launcher for verify-parallel-review-lens-orthogonality.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "verify-parallel-review-lens-orthogonality.ps1" sibling of
REM     this file over this "verify-parallel-review-lens-orthogonality.cmd" file itself -- if both exist, `verify-parallel-review-lens-orthogonality`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "verify-parallel-review-lens-orthogonality.py"
...
echo [verify-parallel-review-lens-orthogonality] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [verify-parallel-review-lens-orthogonality] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0verify-parallel-review-lens-orthogonality.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0verify-parallel-review-lens-orthogonality.py" %*
exit /b %ERRORLEVEL%
