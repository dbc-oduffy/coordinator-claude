# repair-empty-review-trail-ranges.ps1 — python-direct Windows launcher for repair-empty-review-trail-ranges.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "repair-empty-review-trail-ranges.ps1" file over
#     any co-located "repair-empty-review-trail-ranges.cmd" sibling -- `repair-empty-review-trail-ranges` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "repair-empty-review-trail-ranges.py"
...
$_entry = Join-Path $_here 'repair-empty-review-trail-ranges.py'
...
[Console]::Error.WriteLine('[repair-empty-review-trail-ranges] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[repair-empty-review-trail-ranges] Install Python: https://www.python.org/downloads/windows/')
exit 127
