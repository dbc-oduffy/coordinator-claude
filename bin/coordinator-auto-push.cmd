@echo off
setlocal
REM Windows launcher for coordinator-auto-push — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "coordinator-auto-push"
...
:run_baked
"%_py%" "%~dp0coordinator-auto-push" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0coordinator-auto-push" %*
exit /b %ERRORLEVEL%
