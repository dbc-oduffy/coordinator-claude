@echo off
setlocal
REM Windows launcher for coordinator-harvest-deferrals.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "coordinator-harvest-deferrals.ps1" sibling of
REM     this file over this "coordinator-harvest-deferrals.cmd" file itself -- if both exist, `coordinator-harvest-deferrals`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "coordinator-harvest-deferrals.py"
...
echo [coordinator-harvest-deferrals] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [coordinator-harvest-deferrals] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0coordinator-harvest-deferrals.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0coordinator-harvest-deferrals.py" %*
exit /b %ERRORLEVEL%
