@echo off
setlocal
REM Windows launcher for coordinator-harvest-deferrals — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "coordinator-harvest-deferrals"
...
:run_baked
"%_py%" "%~dp0coordinator-harvest-deferrals" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0coordinator-harvest-deferrals" %*
exit /b %ERRORLEVEL%
