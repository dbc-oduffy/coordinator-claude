@echo off
setlocal
REM Windows launcher for cutover-cli.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "cutover-cli.ps1" sibling of
REM     this file over this "cutover-cli.cmd" file itself -- if both exist, `cutover-cli`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "cutover-cli.py"
...
echo [cutover-cli] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [cutover-cli] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0cutover-cli.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0cutover-cli.py" %*
exit /b %ERRORLEVEL%
