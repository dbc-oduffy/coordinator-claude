# handoff-housekeeping.ps1 — python-direct Windows launcher for handoff-housekeeping.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "handoff-housekeeping.ps1" file over
#     any co-located "handoff-housekeeping.cmd" sibling -- `handoff-housekeeping` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "handoff-housekeeping.py"
...
$_entry = Join-Path $_here 'handoff-housekeeping.py'
...
[Console]::Error.WriteLine('[handoff-housekeeping] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[handoff-housekeeping] Install Python: https://www.python.org/downloads/windows/')
exit 127
