# reaper-resting-batons.ps1 — python-direct Windows launcher for reaper-resting-batons.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "reaper-resting-batons.ps1" file over
#     any co-located "reaper-resting-batons.cmd" sibling -- `reaper-resting-batons` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "reaper-resting-batons.py"
...
$_entry = Join-Path $_here 'reaper-resting-batons.py'
...
[Console]::Error.WriteLine('[reaper-resting-batons] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[reaper-resting-batons] Install Python: https://www.python.org/downloads/windows/')
exit 127
