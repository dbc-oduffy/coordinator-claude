# compose-review-wave.ps1 — python-direct Windows launcher for compose-review-wave.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "compose-review-wave.ps1" file over
#     any co-located "compose-review-wave.cmd" sibling -- `compose-review-wave` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "compose-review-wave.py"
