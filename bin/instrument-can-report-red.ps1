# instrument-can-report-red.ps1 — python-direct Windows launcher for instrument-can-report-red.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "instrument-can-report-red.ps1" file over
#     any co-located "instrument-can-report-red.cmd" sibling -- `instrument-can-report-red` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "instrument-can-report-red.py"
...
$_entry = Join-Path $_here 'instrument-can-report-red.py'
...
[Console]::Error.WriteLine('[instrument-can-report-red] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[instrument-can-report-red] Install Python: https://www.python.org/downloads/windows/')
exit 127
