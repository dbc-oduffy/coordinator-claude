@echo off
setlocal
REM Windows launcher for archive-stamp-cli.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "archive-stamp-cli.ps1" sibling of
REM     this file over this "archive-stamp-cli.cmd" file itself -- if both exist, `archive-stamp-cli`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "archive-stamp-cli.py"
...
echo [archive-stamp-cli] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [archive-stamp-cli] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0archive-stamp-cli.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0archive-stamp-cli.py" %*
exit /b %ERRORLEVEL%
