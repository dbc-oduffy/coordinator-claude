@echo off
setlocal
REM Windows launcher for archive-stamp-cli — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "archive-stamp-cli"
...
:run_baked
"%_py%" "%~dp0archive-stamp-cli" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0archive-stamp-cli" %*
exit /b %ERRORLEVEL%
