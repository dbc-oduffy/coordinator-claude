@echo off
setlocal
REM Windows launcher for measure-loopback-round-trip.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "measure-loopback-round-trip.ps1" sibling of
REM     this file over this "measure-loopback-round-trip.cmd" file itself -- if both exist, `measure-loopback-round-trip`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "measure-loopback-round-trip.py"
...
echo [measure-loopback-round-trip] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [measure-loopback-round-trip] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0measure-loopback-round-trip.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0measure-loopback-round-trip.py" %*
exit /b %ERRORLEVEL%
