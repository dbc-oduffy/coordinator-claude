# tier-u-grant-cli.ps1 — python-direct Windows launcher for tier-u-grant-cli.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "tier-u-grant-cli.ps1" file over
#     any co-located "tier-u-grant-cli.cmd" sibling -- `tier-u-grant-cli` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "tier-u-grant-cli.py"
...
$_entry = Join-Path $_here 'tier-u-grant-cli.py'
...
[Console]::Error.WriteLine('[tier-u-grant-cli] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[tier-u-grant-cli] Install Python: https://www.python.org/downloads/windows/')
exit 127
