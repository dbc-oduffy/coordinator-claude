@echo off
setlocal
REM Windows launcher for subagent-statusline.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "subagent-statusline.ps1" sibling of
REM     this file over this "subagent-statusline.cmd" file itself -- if both exist, `subagent-statusline`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "subagent-statusline.py"
...
echo [subagent-statusline] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [subagent-statusline] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0subagent-statusline.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0subagent-statusline.py" %*
exit /b %ERRORLEVEL%
