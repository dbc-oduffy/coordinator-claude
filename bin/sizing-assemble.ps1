# sizing-assemble.ps1 — python-direct Windows launcher for sizing-assemble.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "sizing-assemble.ps1" file over
#     any co-located "sizing-assemble.cmd" sibling -- `sizing-assemble` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "sizing-assemble.py"
...
$_entry = Join-Path $_here 'sizing-assemble.py'
...
[Console]::Error.WriteLine('[sizing-assemble] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[sizing-assemble] Install Python: https://www.python.org/downloads/windows/')
exit 127
