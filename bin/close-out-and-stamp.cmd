@echo off
setlocal
REM Windows launcher for close-out-and-stamp — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "close-out-and-stamp"
...
:run_baked
"%_py%" "%~dp0close-out-and-stamp" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0close-out-and-stamp" %*
exit /b %ERRORLEVEL%
