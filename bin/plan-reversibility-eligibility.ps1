# plan-reversibility-eligibility.ps1 — python-direct Windows launcher for plan-reversibility-eligibility.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "plan-reversibility-eligibility.ps1" file over
#     any co-located "plan-reversibility-eligibility.cmd" sibling -- `plan-reversibility-eligibility` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "plan-reversibility-eligibility.py"
...
$_entry = Join-Path $_here 'plan-reversibility-eligibility.py'
...
[Console]::Error.WriteLine('[plan-reversibility-eligibility] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[plan-reversibility-eligibility] Install Python: https://www.python.org/downloads/windows/')
exit 127
