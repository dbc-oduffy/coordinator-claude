@echo off
setlocal
REM Windows launcher for coordinator-safe-commit — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "coordinator-safe-commit"
...
:run_baked
"%_py%" "%~dp0coordinator-safe-commit" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0coordinator-safe-commit" %*
exit /b %ERRORLEVEL%
