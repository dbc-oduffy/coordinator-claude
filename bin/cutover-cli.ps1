# cutover-cli.ps1 — python-direct Windows launcher for cutover-cli.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "cutover-cli.ps1" file over
#     any co-located "cutover-cli.cmd" sibling -- `cutover-cli` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "cutover-cli.py"
...
$_entry = Join-Path $_here 'cutover-cli.py'
...
[Console]::Error.WriteLine('[cutover-cli] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[cutover-cli] Install Python: https://www.python.org/downloads/windows/')
exit 127
