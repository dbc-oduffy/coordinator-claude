# percolate-mirror.ps1 — python-direct Windows launcher for percolate-mirror.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "percolate-mirror.ps1" file over
#     any co-located "percolate-mirror.cmd" sibling -- `percolate-mirror` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "percolate-mirror.py"
...
$_entry = Join-Path $_here 'percolate-mirror.py'
...
[Console]::Error.WriteLine('[percolate-mirror] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[percolate-mirror] Install Python: https://www.python.org/downloads/windows/')
exit 127
