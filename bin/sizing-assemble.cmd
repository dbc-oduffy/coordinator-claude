@echo off
setlocal
REM Windows launcher for sizing-assemble — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "sizing-assemble"
...
:run_baked
"%_py%" "%~dp0sizing-assemble" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0sizing-assemble" %*
exit /b %ERRORLEVEL%
