@echo off
setlocal
REM Windows launcher for percolate-full-payload-proof.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "percolate-full-payload-proof.ps1" sibling of
REM     this file over this "percolate-full-payload-proof.cmd" file itself -- if both exist, `percolate-full-payload-proof`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "percolate-full-payload-proof.py"
...
echo [percolate-full-payload-proof] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [percolate-full-payload-proof] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0percolate-full-payload-proof.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0percolate-full-payload-proof.py" %*
exit /b %ERRORLEVEL%
