@echo off
setlocal
REM Windows launcher for publish_refusal_record.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "publish_refusal_record.ps1" sibling of
REM     this file over this "publish_refusal_record.cmd" file itself -- if both exist, `publish_refusal_record`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "publish_refusal_record.py"
...
echo [publish_refusal_record] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [publish_refusal_record] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0publish_refusal_record.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0publish_refusal_record.py" %*
exit /b %ERRORLEVEL%
