@echo off
setlocal
REM Windows launcher for review-brightline-gate.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "review-brightline-gate.ps1" sibling of
REM     this file over this "review-brightline-gate.cmd" file itself -- if both exist, `review-brightline-gate`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "review-brightline-gate.py"
...
echo [review-brightline-gate] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [review-brightline-gate] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0review-brightline-gate.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0review-brightline-gate.py" %*
exit /b %ERRORLEVEL%
