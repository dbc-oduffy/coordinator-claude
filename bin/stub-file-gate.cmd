@echo off
setlocal
REM Windows launcher for stub-file-gate.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "stub-file-gate.ps1" sibling of
REM     this file over this "stub-file-gate.cmd" file itself -- if both exist, `stub-file-gate`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "stub-file-gate.py"
...
echo [stub-file-gate] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [stub-file-gate] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0stub-file-gate.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0stub-file-gate.py" %*
exit /b %ERRORLEVEL%
