# publish-time-transform-py.ps1 — python-direct Windows launcher for publish-time-transform-py.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "publish-time-transform-py.ps1" file over
#     any co-located "publish-time-transform-py.cmd" sibling -- `publish-time-transform-py` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "publish-time-transform-py.py"
...
$_entry = Join-Path $_here 'publish-time-transform-py.py'
...
[Console]::Error.WriteLine('[publish-time-transform-py] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[publish-time-transform-py] Install Python: https://www.python.org/downloads/windows/')
exit 127
