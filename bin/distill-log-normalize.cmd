@echo off
setlocal
REM Windows launcher for distill-log-normalize.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "distill-log-normalize.ps1" sibling of
REM     this file over this "distill-log-normalize.cmd" file itself -- if both exist, `distill-log-normalize`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "distill-log-normalize.py"
...
echo [distill-log-normalize] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [distill-log-normalize] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0distill-log-normalize.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0distill-log-normalize.py" %*
exit /b %ERRORLEVEL%
