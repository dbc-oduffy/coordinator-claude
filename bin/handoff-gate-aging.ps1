# handoff-gate-aging.ps1 — python-direct Windows launcher for handoff-gate-aging.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "handoff-gate-aging.ps1" file over
#     any co-located "handoff-gate-aging.cmd" sibling -- `handoff-gate-aging` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "handoff-gate-aging.py"
...
$_entry = Join-Path $_here 'handoff-gate-aging.py'
...
[Console]::Error.WriteLine('[handoff-gate-aging] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[handoff-gate-aging] Install Python: https://www.python.org/downloads/windows/')
exit 127
