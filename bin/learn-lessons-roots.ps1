...
#   - On bare-name resolution, PowerShell prefers this "learn-lessons-roots.ps1" file over
#     any co-located "learn-lessons-roots.cmd" sibling -- `learn-lessons-roots` typed bare in a pwsh
