@echo off
setlocal
REM Windows launcher for render-project-tracker — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "render-project-tracker"
...
:run_baked
"%_py%" "%~dp0render-project-tracker" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0render-project-tracker" %*
exit /b %ERRORLEVEL%
