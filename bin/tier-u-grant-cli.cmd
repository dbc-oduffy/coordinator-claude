@echo off
setlocal
REM Windows launcher for tier-u-grant-cli — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "tier-u-grant-cli"
...
:run_baked
"%_py%" "%~dp0tier-u-grant-cli" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0tier-u-grant-cli" %*
exit /b %ERRORLEVEL%
