@echo off
setlocal
REM Windows launcher for draft-plan-aging.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "draft-plan-aging.ps1" sibling of
REM     this file over this "draft-plan-aging.cmd" file itself -- if both exist, `draft-plan-aging`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "draft-plan-aging.py"
...
echo [draft-plan-aging] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [draft-plan-aging] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0draft-plan-aging.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0draft-plan-aging.py" %*
exit /b %ERRORLEVEL%
