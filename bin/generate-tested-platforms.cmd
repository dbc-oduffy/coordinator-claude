@echo off
setlocal
REM Windows launcher for generate-tested-platforms — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "generate-tested-platforms"
...
:run_baked
"%_py%" "%~dp0generate-tested-platforms" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0generate-tested-platforms" %*
exit /b %ERRORLEVEL%
