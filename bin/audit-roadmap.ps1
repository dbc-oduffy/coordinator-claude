# audit-roadmap.ps1 — python-direct Windows launcher for audit-roadmap.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "audit-roadmap.ps1" file over
#     any co-located "audit-roadmap.cmd" sibling -- `audit-roadmap` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "audit-roadmap.py"
...
$_entry = Join-Path $_here 'audit-roadmap.py'
...
[Console]::Error.WriteLine('[audit-roadmap] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[audit-roadmap] Install Python: https://www.python.org/downloads/windows/')
exit 127
