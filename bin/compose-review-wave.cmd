@echo off
setlocal
REM Windows launcher for compose-review-wave.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "compose-review-wave.ps1" sibling of
REM     this file over this "compose-review-wave.cmd" file itself -- if both exist, `compose-review-wave`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "compose-review-wave.py"
...
echo [compose-review-wave] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [compose-review-wave] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0compose-review-wave.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0compose-review-wave.py" %*
exit /b %ERRORLEVEL%
