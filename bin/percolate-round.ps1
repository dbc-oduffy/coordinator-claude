# percolate-round.ps1 — python-direct Windows launcher for percolate-round.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "percolate-round.ps1" file over
#     any co-located "percolate-round.cmd" sibling -- `percolate-round` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "percolate-round.py"
...
$_entry = Join-Path $_here 'percolate-round.py'
...
[Console]::Error.WriteLine('[percolate-round] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[percolate-round] Install Python: https://www.python.org/downloads/windows/')
exit 127
