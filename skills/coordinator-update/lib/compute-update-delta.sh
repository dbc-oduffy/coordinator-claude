...
# Review: code-reviewer (F14) — pwd -P resolves symlinks so the marker walk uses
# the real physical path rather than the logical/symlink path.
_COMPUTE_DELTA_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd -P)"
