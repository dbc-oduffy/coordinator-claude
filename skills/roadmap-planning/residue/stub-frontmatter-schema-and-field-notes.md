...
## Four schema fields also NOT in the scaffolded template

`origin_session`, `origin_handoff`, `origin_plan_id`, `origin_goal_id` are NOT emitted by `_scaffold_spinoff_roadmap`; they are hand-filled post-scaffold per "Origin-provenance fields — fill at stub-authoring time" below.
