...
**Routing:** Registers the Front-End Reviewer for front-end signals and the UX Reviewer for UX signals. The Front-End Reviewer and the UX Reviewer backstop each other within this plugin; both can escalate to the Staff Engineer (coordinator) for architectural concerns.
