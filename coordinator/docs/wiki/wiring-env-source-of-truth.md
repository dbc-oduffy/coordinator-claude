...
it**, and **how precedence works** after the 2026-05-18 cleanup that moved wiring
consumption from shell wrappers into the daemon itself.
...
the same `_load_wiring_env` call. There is no longer a wrapper-vs-direct split.
...
**Removed 2026-05-18** by spinoff `docs/plans/2026-05-18-daemon-reads-wiring-env-directly.md`.
...
machine. When a second Python consumer ships (e.g., `geneva-mvp`), the
