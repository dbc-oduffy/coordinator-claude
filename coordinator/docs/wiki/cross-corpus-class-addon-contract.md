...
Policy reference: `X:/project-rag-ue-addon/docs/decisions/DR-CORPUS-NAMES-001-addon-contributed-corpus-band-naming-policy.md`
...
- `X:/project-rag-ue-addon/docs/wiki/multi-corpus-source-doctrine.md` — collision precedence rule
- `X:/project-rag-ue-addon/docs/decisions/DR-CORPUS-NAMES-001-addon-contributed-corpus-band-naming-policy.md` — naming policy + 3-tier stability model
