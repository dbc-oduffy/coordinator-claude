...
physical-extraction risk. DroneSim can confirm non-functional change
...
rollback cost and DroneSim regression risk. The scaffold + extract split
...
| **2b (extraction)** | Move UE producers/tools to holodeck addon | Addon (`claude_unreal_holodeck.project_rag_addon`) |
...
- **A-1 Option 2:** receiver identity → holodeck core
