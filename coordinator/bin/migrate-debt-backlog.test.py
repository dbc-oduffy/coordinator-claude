...
|----|--------|--------|------|------|-----------------|
| DSR-2026-04-02-1 | daily-review/patrik/2026-04-02 | resolved | Codex plugin registered as marketplace source with no version pin. | Reproducibility liability — upstream change silently breaks plugin load. | Pin to a resolved commit SHA or release tag before open-source launch. |
        ...
        with open(self._dryrun, "w", encoding="utf-8") as fh:
            json.dump([{"source_line": 1, "classification": "to-migrate",
                        ...
                        "parsed": {
                            ...
                            "source": "daily-review/patrik/2026-04-02",
