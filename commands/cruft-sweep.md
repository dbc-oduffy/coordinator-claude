...
`"${COORDINATOR_SETTINGS_HOME:-$HOME/.coordinator-claude-settings}/bin/cruft-sweep" --dry-run --json --class all`
...
`"${COORDINATOR_SETTINGS_HOME:-$HOME/.coordinator-claude-settings}/bin/cruft-sweep" --apply --class <selected>`
