...
<!-- CALIBRATION: this fidelity check is defensive — the failure mode is high-cost-low-frequency
     and the Sonnet check is cheap. Revisit prompt complexity if escalation remains unfired
     after further runs. -->
