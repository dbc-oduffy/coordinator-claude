...
1. **Get today's changed files** — the file names differing between `HEAD` and its merge-base
   with `origin/main`; if that merge-base isn't resolvable, fall back to the last 10 commits.
